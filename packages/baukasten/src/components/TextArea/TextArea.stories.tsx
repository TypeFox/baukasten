...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component:
                    'A multi-line text input component with size, resize, and error message support. Fully integrates with the design system tokens for consistent theming. For labels, use the FieldLabel or FormGroup components.',
            },
        },
    },
    tags: ['autodocs'],
    ...
    argTypes: {
        ...
        resize: {
            ...
            description:
                'Resize behavior for the textarea. When minRows/maxRows is set, defaults to "none"',
            table: {
        ...
        rows: {
            control: 'number',
            description:
                'Number of visible text rows (static height, ignored when minRows/maxRows is set)',
            table: {
        ...
        >
            ...
            <div>
                ...
                >
                    ...
                    <TextArea
                        ...
                        fullWidth
                    />
                    <TextArea placeholder="Disabled" disabled rows={3} fullWidth />
                </div>
            </div>
            ...
            <div>
                ...
                >
                    ...
                    <TextArea
                        minRows={1}
                        maxRows={4}
                        placeholder="Compact: 1 to 4 rows"
                        fullWidth
                    />
            ...
            <div>
                ...
                >
                    ...
                    <TextArea
                        size="lg"
                        placeholder="Large with no resize"
                        resize="none"
                        rows={4}
                        fullWidth
                    />
