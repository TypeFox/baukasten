...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component:
                    'A circular loading spinner component that follows VSCode design patterns. Uses a rotating border animation to indicate loading or processing states. Perfect for async operations, data fetching, and loading indicators.',
            },
        },
    },
    tags: ['autodocs'],
    ...
    render: () => (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--bk-spacing-6)' }}>
            ...
            <div>
                ...
                >
                    Please wait while we fetch your data <Spinner size="xs" /> this may take a
                    moment.
                </div>
            </div>
        </div>
