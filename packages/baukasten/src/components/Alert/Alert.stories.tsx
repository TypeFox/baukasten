...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component:
                    'A prestyled container for displaying important information to users. Supports multiple variants (info, success, warning, error) with default icons, optional title, and dismissible functionality. Fully integrates with the design system tokens for consistent theming.',
            },
        },
    },
    tags: ['autodocs'],
    ...
    render: () => (
        ...
        >
            <Alert variant="info" title="Information">
                This alert includes a title to provide additional context and structure to the
                message.
            </Alert>
...
export const Dismissible: Story = {
    render: () => (
        ...
        >
            ...
            <Alert variant="error" closable onClose={() => console.log('Error alert closed')}>
...
export const CustomIcons: Story = {
    render: () => (
        ...
        >
            <Alert variant="info" icon={<Icon name="lightbulb" size="md" />} title="Tip">
                You can override the default icon with any custom icon you prefer.
            </Alert>
            <Alert variant="success" icon={<Icon name="rocket" size="md" />} title="Launched">
                Your application has been successfully deployed to production!
            </Alert>
            <Alert variant="warning" icon={<Icon name="flame" size="md" />} title="Hot Feature">
                This is a brand new feature that just launched. Try it out!
            </Alert>
            <Alert variant="error" icon={<Icon name="bug" size="md" />} title="Bug Report">
    ...
    render: () => (
        ...
        >
            ...
            <Alert variant="success" title="Medium Length Message">
                This alert contains a moderate amount of text that provides enough detail without
                being overwhelming.
            </Alert>

            <Alert variant="warning" title="Longer Content Example">
                This alert demonstrates how the component handles longer content. The text wraps
                naturally and maintains proper spacing and readability. You can include multiple
                sentences or even paragraphs of information. The component automatically adjusts its
                height to accommodate the content while maintaining the design consistency.
            </Alert>
    ...
    render: () => (
        ...
        >
            <div>
                ...
                <Alert variant="info" title="System Update Available" closable>
                    A new version of the application is available. Please save your work and restart
                    to apply the update.
                </Alert>
            </div>
            ...
            <div>
                ...
                <Alert variant="success" title="Form Submitted">
                    Your form has been successfully submitted. We'll review it and get back to you
                    within 24 hours.
                </Alert>
            </div>
            ...
            <div>
                ...
                <Alert variant="error" title="Connection Failed" closable>
                    Unable to connect to the API server. Please check your internet connection and
                    try again.
                </Alert>
            </div>
        </div>
        ...
        >
            ...
            <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--bk-gap-md)' }}>
                    <Alert variant="info">Informational alert with default styling and icon.</Alert>
                    <Alert variant="success">Success alert indicating a positive outcome.</Alert>
                    <Alert variant="warning">Warning alert for important notices.</Alert>
                    <Alert variant="error">Error alert for critical issues.</Alert>
                </div>
            </div>
            ...
            <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--bk-gap-md)' }}>
                    <Alert variant="info" title="Tip" closable>
