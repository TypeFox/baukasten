...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component:
                    'A simple component for creating visual separation between content sections. Supports horizontal and vertical orientations, optional labels, and different border styles. Perfect for organizing content and creating visual hierarchy.',
            },
        },
    },
    tags: ['autodocs'],
...
export const Basic: Story = {
    render: () => (
        <div style={{ maxWidth: '600px' }}>
            ...
            <Divider />
            <Paragraph>This is content below the divider. Simple and clean separation.</Paragraph>
        </div>
    ),
    parameters: {
        docs: {
    ...
    render: () => (
        ...
        >
            <div>
                ...
                <Paragraph>
                    Welcome to our application. This section introduces the main features.
                </Paragraph>
...
export const ContentSections: Story = {
    render: () => (
        <div style={{ maxWidth: '700px' }}>
            ...
            <Paragraph>
                Welcome to our comprehensive documentation. This guide will help you understand all
            ...
            <Paragraph>
                Our platform provides a complete solution for building modern web applications. It
                includes everything you need to get started quickly and scale efficiently.
            </Paragraph>
            ...
            <Paragraph>
                The platform offers numerous features including real-time collaboration, advanced
                analytics, seamless integrations, and enterprise-grade security.
            </Paragraph>

            <Divider label="Next Steps" labelAlign="left" />

            <Paragraph>
                Now that you understand the basics, explore our API reference and check out the
                example projects to see the platform in action.
            </Paragraph>
        </div>
    ),
    parameters: {
...
export const Showcase: Story = {
    render: () => (
        <div style={{ padding: 'var(--bk-spacing-4)', maxWidth: '800px', margin: '0 auto' }}>
            ...
            {/* Custom Colors */}
            <section
                style={{ marginTop: 'var(--bk-spacing-8)', marginBottom: 'var(--bk-spacing-4)' }}
            >
