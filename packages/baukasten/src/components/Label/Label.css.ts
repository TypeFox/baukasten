...
export const label = recipe({
    ...
    compoundVariants: [
        // Input variant + size
        {
            variants: { variant: 'input', size: 'xs' },
            style: {
        ...
        {
            variants: { variant: 'input', size: 'sm' },
            style: {
        ...
        {
            variants: { variant: 'input', size: 'md' },
            style: {
                padding: '0 var(--bk-spacing-2)',
                gap: 'var(--bk-gap-sm)',
        ...
        {
            variants: { variant: 'input', size: 'lg' },
            style: {
        ...
        {
            variants: { variant: 'input', size: 'xl' },
            style: {
        ...
        // Checkbox variant + size
        {
            ...
            style: { fontSize: 'var(--bk-font-size-xs)' },
        },
        {
        ...
        },
        {
            ...
            style: { fontSize: 'var(--bk-font-size-md)' },
        },
        {
            variants: { variant: 'checkbox', size: 'lg' },
            style: { fontSize: 'var(--bk-font-size-base)' },
        },
        {
            variants: { variant: 'checkbox', size: 'xl' },
            style: { fontSize: 'var(--bk-font-size-lg)' },
        },
        // Input + fullWidth
        ...
        // Input + hasError
        {
            variants: { variant: 'input', hasError: true },
            style: { borderColor: 'var(--bk-color-input-error)' },
        },
        // TextArea + hasError
        {
            variants: { variant: 'textarea', hasError: true },
            style: { borderColor: 'var(--bk-color-input-error)' },
        },
    ],
