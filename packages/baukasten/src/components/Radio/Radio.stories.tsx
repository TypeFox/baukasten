...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component:
                    'A radio button component for selecting a single option from a group. Use with the Label component (variant="checkbox") for accessible labels, and RadioGroup for managing group state. Fully integrates with VSCode/Theia theme variables for consistent theming.',
            },
        },
    },
    tags: ['autodocs'],
    ...
    render: () => {
        ...
        return (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--bk-spacing-4)' }}>
                ...
                >
                    Selected:{' '}
                    <strong style={{ color: 'var(--bk-color-foreground)' }}>{theme}</strong>
                </div>
            </div>
        );
    },
    ...
    render: () => {
        ...
        return (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--bk-spacing-4)' }}>
                ...
                >
                    Selected size:{' '}
                    <strong style={{ color: 'var(--bk-color-foreground)' }}>{size}</strong>
                </div>
            </div>
        );
    },
            ...
            <RadioGroup name="plan-multiline" value={plan} onChange={setPlan}>
                ...
                <Label variant="checkbox" size="md">
                    ...
                    <span>
                        ...
                        >
                            For professionals. Includes 100GB storage, priority support, and
                            advanced features.
                        </span>
                    </span>
                </Label>
                <Label variant="checkbox" size="md">
                    ...
                    <span>
                        ...
                        >
                            For teams. Unlimited storage, dedicated support, and custom
                            integrations.
                        </span>
                    </span>
                </Label>
            ...
            >
                <div>
                    ...
                    <RadioGroup
                        ...
                        onChange={(value) =>
                            setFormData({ ...formData, deliveryMethod: value as string })
                        }
                    >
                        <Label variant="checkbox" size="md">
                ...
                <div>
                    ...
                    <RadioGroup
                        ...
                        onChange={(value) =>
                            setFormData({ ...formData, paymentMethod: value as string })
                        }
                    >
                        <Label variant="checkbox" size="md">
                            <Radio value="credit" />
                ...
                <div>
                    ...
                    <RadioGroup
                        ...
                        onChange={(value) =>
                            setFormData({ ...formData, newsletter: value as string })
                        }
                    >
                        <Label variant="checkbox" size="md">
                            <Radio value="daily" />
