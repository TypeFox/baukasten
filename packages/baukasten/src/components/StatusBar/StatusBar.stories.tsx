...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component:
                    "A bottom status bar component for displaying contextual information, similar to VSCode's status bar. Organize items using StatusBarSection for left/right alignment, and StatusBarItem for individual elements. Supports icons, semantic color variants, click handlers, and tooltips.",
            },
        },
    },
    tags: ['autodocs'],
            ...
            return (
                <div>
                    ...
                    >
                        ...
                        >
                            Current state: Branch: <strong>{branch}</strong>, Errors:{' '}
                            <strong>{errors}</strong>, Warnings: <strong>{warnings}</strong>,
                            Position:{' '}
                            <strong>
                                Ln {line}, Col {col}
                            </strong>
    ...
    render: () => (
        <StatusBar>
            ...
            <StatusBarSection align="right">
                ...
                <StatusBarItem
                    onClick={() => console.log('Spaces clicked')}
                    tooltip="Indent Using Spaces"
                >
                    Spaces: 2
                </StatusBarItem>
                ...
                <StatusBarItem
                    onClick={() => console.log('Line ending clicked')}
