...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component:
                    'A versatile button component with multiple variants, sizes, and styling options. Fully integrates with VSCode/Theia theme variables for consistent theming. Supports icons, different layouts, and all standard button events.',
            },
        },
    },
    tags: ['autodocs'],
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--bk-spacing-4)' }}>
            ...
            <div>
                ...
                <div style={{ display: 'flex', gap: 'var(--bk-gap-sm)', alignItems: 'center' }}>
                    ...
                    <Button variant="primary" circular outline>
                        !
                    </Button>
                </div>
            </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--bk-spacing-3)' }}>
            <div>
                ...
                >
                    ...
                    <Button variant="primary" circular disabled>
                        +
                    </Button>
                </div>
            </div>
        ...
        >
            ...
            <div>
                ...
                >
                    <div style={{ display: 'flex', gap: 'var(--bk-gap-xs)', alignItems: 'center' }}>
                        <Button variant="primary" circular size="xs">
                            +
                        </Button>
                        <Button variant="primary" circular size="sm">
                            +
                        </Button>
                        <Button variant="primary" circular size="md">
                            +
                        </Button>
                        <Button variant="primary" circular size="lg">
                            +
                        </Button>
                        <Button variant="primary" circular size="xl">
                            +
                        </Button>
                    </div>
                    <div style={{ display: 'flex', gap: 'var(--bk-gap-xs)', alignItems: 'center' }}>
            ...
            <div>
                ...
                >
                    ...
                    <div style={{ display: 'flex', gap: 'var(--bk-gap-sm)' }}>
                        <Button variant="secondary" width="wide">
                            Wide Button
                        </Button>
    ...
    render: () => (
        ...
        `}
            ...
            <div>
                ...
                >
                    Custom classes are merged with built-in styles, allowing you to extend the
                    button appearance.
                </p>
                <div
                    style={{
                ...
                >
                    ...
                    <Button variant="primary" className="custom-rotate">
                        With Rotation
                    </Button>
                    <Button variant="primary" className="custom-shadow">
                        With Shadow
                    </Button>
                    <Button variant="secondary" className="custom-gradient">
                        With Gradient
                    </Button>
                    <Button variant="ghost" className="custom-border">
                        With Dashed Border
                    </Button>
                </div>
            </div>
            <div>
                ...
                >
                    <Button variant="primary" className="custom-rotate custom-shadow">
                        Rotate + Shadow
                    </Button>
                    <Button variant="secondary" className="custom-gradient custom-shadow">
                        Gradient + Shadow
                    </Button>
                </div>
            </div>
