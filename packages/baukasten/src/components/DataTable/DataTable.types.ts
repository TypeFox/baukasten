 ...
 */
export interface UndoableDataTableTransactionResult<
    TData,
> extends DataTableTransactionResult<TData> {
...
export interface DataTableRef<TData> {
    ...
    applyTransaction(
        ...
        undoable: true,
    ): UndoableDataTableTransactionResult<TData>;
    /** Apply a batch mutation to the table data */
    applyTransaction(
        tx: DataTableTransaction<TData>,
        undoable?: false,
    ): DataTableTransactionResult<TData>;
    /**
