...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component:
                    'A square icon-only button whose width and height match the normal Button height for each size. Ideal for toolbar actions, compact icon controls, and icon actions that need to align with text buttons. Supports all button variants, sizes, and outline styles.',
            },
        },
    },
    tags: ['autodocs'],
                ...
                >
                    ...
                    <div
                        style={{
                            ...
                            margin: '0 var(--bk-spacing-0-5)',
                        }}
                    />
                    <IconButton
                        icon={<Icon name="link-external" />}
                        variant="ghost"
                        size="sm"
                        aria-label="Insert Link"
                    />
                    <IconButton
                        icon={<Icon name="file-media" />}
                        variant="ghost"
                        size="sm"
