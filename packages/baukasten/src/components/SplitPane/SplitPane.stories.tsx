...
export const Interactive: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: 'The interactive playground allows you to experiment with different orientations and settings. Drag the divider between panes to resize them.',
            },
        },
    },
};
...
export const WithMinSize: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: "Set minimum size constraints on panes to prevent them from becoming too small. Try dragging the divider - the panes won't go below their minimum sizes.",
            },
        },
    },
};
...
export const WithMaxSize: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: 'Set maximum size constraints on panes to prevent them from growing too large.',
            },
        },
    },
};
...
export const WithPreferredSizes: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: 'Set preferred initial sizes for panes. Use pixels for fixed sizes or values between 0-1 for proportional sizes.',
            },
        },
    },
};
...
export const Nested: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: "Nest split panes to create complex layouts like VSCode's editor groups with panels.",
            },
        },
    },
};
...
export const VSCodeLayout: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: 'A complete VSCode-style layout with a resizable sidebar, split editor groups, and a bottom panel. All dividers are draggable and highlight in primary color during interaction.',
            },
        },
    },
};
...
export const Showcase: Story = {
    ...
    render: () => (
        ...
        >
            <div>
                <h2 style={{ marginBottom: 'var(--bk-padding-md)' }}>Basic Split Panes</h2>
                <div
                    style={{
                        display: 'grid',
                ...
                >
                    <div>
                        ...
                        <div
                            style={{ height: '300px', border: '1px solid var(--bk-color-border)' }}
                        >
                            <SplitPane orientation="horizontal">
                                <SplitPane.Pane>
                                    <DemoContent color="color-mix(in srgb, var(--bk-color-info) 15%, transparent)">
            ...
            <div>
                <h2 style={{ marginBottom: 'var(--bk-padding-md)' }}>Multiple Panes</h2>
            ...
            <div>
                <h2 style={{ marginBottom: 'var(--bk-padding-md)' }}>Constraints & Sizing</h2>
                <div
                    style={{
                        display: 'grid',
                        gridTemplateColumns: '1fr 1fr',
                ...
                >
                    ...
                    <div>
                        <h3 style={{ marginBottom: 'var(--bk-padding-sm)' }}>Preferred Sizes</h3>
                        <div
                            style={{ height: '300px', border: '1px solid var(--bk-color-border)' }}
                        >
                            <SplitPane orientation="horizontal">
    ...
    parameters: {
        ...
        docs: {
            description: {
                story: 'A comprehensive showcase of all SplitPane features including orientations, multiple panes, constraints, and nested layouts.',
            },
        },
    },
};
