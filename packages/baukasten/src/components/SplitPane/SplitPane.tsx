...
const SplitPaneComponent = ({
    ...
    const panes = React.Children.toArray(children).filter(
        (child): child is React.ReactElement<PaneProps> => React.isValidElement(child),
    );
    ...
    const handleMouseDown = useCallback(
        (index: number, e: React.MouseEvent) => {
            ...
            dragStartPos.current = actualOrientation === 'vertical' ? e.clientY : e.clientX;
    ...
    const handleMouseMove = useCallback(
        (e: MouseEvent) => {
            ...
            const currentPos = actualOrientation === 'vertical' ? e.clientY : e.clientX;
