...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component:
                    "A custom select dropdown component with keyboard navigation, search functionality, auto-positioning, and contextual descriptions. Fully integrates with the design system and VSCode theme variables. Features a description panel that displays additional context for the highlighted option, plus support for default/recommended labels. Matches VSCode's native dropdown styling with blue focus borders. Supports icons, filtering, disabled options, and all standard form behaviors.",
            },
        },
    },
    tags: ['autodocs'],
    argTypes: {
        ...
        showDescriptionPanel: {
            control: 'boolean',
            description:
                'Whether to show description panel at the bottom of dropdown (only when descriptions exist)',
            table: {
        ...
        dropdownClassName: {
            control: 'text',
            description:
                'Additional CSS class name for the dropdown portal element (useful for custom dropdown styling)',
        },
    },
    ...
    render: () => (
        ...
        >
            <div>
                ...
                >
                    Search matches against descriptions. Hover over options to see descriptions in
                    the panel below.
                </p>
            </div>
    ...
    render: () => (
        ...
        >
            <div>
                ...
                <Select options={languageOptions} placeholder="Select a programming language..." />
                <p
                    style={{
                        marginTop: 'var(--bk-spacing-1)',
                        fontSize: 'var(--bk-font-size-xs)',
    ...
    render: () => {
        ...
        const themeOptions: SelectOption[] = [
            ...
            },
            {
                value: 'light',
                label: 'Light Theme',
                description: 'Light color scheme for bright environments',
            },
            {
                value: 'high-contrast',
                label: 'High Contrast',
        ...
        return (
            ...
            >
                ...
                <div>
                    ...
                    <Select options={themeOptions} placeholder="Select a theme..." />
                    <p
                        style={{
                            marginTop: 'var(--bk-spacing-1)',
                            fontSize: 'var(--bk-font-size-xs)',
    ...
    render: () => {
        ...
        const projectOptions: ProjectOption[] = [
            ...
            },
            {
                value: 'p3',
                label: 'API Gateway',
                description: 'Node.js, Redis, Docker',
                status: 'pending',
                progress: 20,
                members: 2,
            },
            {
                ...
                description: 'React, D3.js, MongoDB',
                status: 'completed',
                progress: 100,
                members: 4,
            },
                                    ...
                                    >
                                        ...
                                        <span
                                            style={{
                                                fontSize: 'var(--bk-font-size-xs)',
                                                padding:
                                                    'var(--bk-spacing-0-5) var(--bk-spacing-1-5)',
                        ...
                        renderOption={(option) => (
                            <div
                                style={{
                                    ...
                                    alignItems: 'center',
                                    gap: 'var(--bk-gap-md)',
                                    padding: 'var(--bk-spacing-0-5) 0',
                                }}
                            >
                                <Icon
                                    name={getFileIcon(option.label || '')}
                                    style={{ fontSize: 'var(--bk-font-size-lg)', flexShrink: 0 }}
                                />
                                <div style={{ flex: 1, minWidth: 0 }}>
                                    <div
                                        style={{
    ...
    render: () => (
        ...
        >
            ...
            <div>
                ...
                <Select options={basicOptions} position="bottom" placeholder="Always opens below" />
            </div>
            <div>
                <h4
                    style={{
                ...
                <Select options={basicOptions} position="top" placeholder="Always opens above" />
            </div>
        </div>
    ),
    parameters: {
    ...
    render: () => (
        ...
        >
            <div>
                ...
                <Select options={basicOptions} disabled defaultValue="option2" />
            </div>
            <div>
                <h4
                    style={{
    ...
    return (
        ...
        >
            ...
            <div>
                ...
                <Select
                    ...
                    onChange={(value) =>
                        setFormData({
                            ...formData,
                            experience: Array.isArray(value) ? value[0] || '' : value,
                        })
                    }
            ...
            >
                ...
                <div>
                    <strong>Experience:</strong> {formData.experience || 'Not selected'}
                </div>
            </div>
        </div>
    );
        ...
        >
            ...
            <div>
                ...
                <Select
                    ...
                    onChange={(value) =>
                        setFormData({ ...formData, languages: Array.isArray(value) ? value : [] })
                    }
            ...
            <div>
                ...
                <Select
                    ...
                    onChange={(value) =>
                        setFormData({ ...formData, frameworks: Array.isArray(value) ? value : [] })
                    }
            ...
            >
                <div>
                    <strong>Languages ({formData.languages.length}):</strong>{' '}
                            ...
                            >
                                <span
                                    style={{
                                        ...
                                        borderRadius: '50%',
                                        backgroundColor:
                                            option.value === 'active' ? '#4caf50' : '#ff9800',
                                    }}
                                />
                                {option.label}
                            </span>
            ...
            <div>
                ...
                >
                    ...
                    <Select
                        ...
                        error="This field is required"
                    />
                    <Select options={optionsWithDisabled} placeholder="With disabled options" />
                </div>
            </div>
