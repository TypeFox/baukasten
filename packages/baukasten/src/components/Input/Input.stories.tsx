...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component:
                    'A text input component with size and error message support. Fully integrates with the design system tokens for consistent theming. For labels with prefix/suffix text, use the Label component wrapper.',
            },
        },
    },
    tags: ['autodocs'],
        ...
        >
            ...
            <div>
                ...
                >
                    ...
                    <Input placeholder="With error" error="This field is required" fullWidth />
