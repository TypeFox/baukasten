...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component:
                    'A context menu that appears on right-click, positioned at the cursor coordinates. Wraps the existing Menu system and supports all Menu features including MenuItem, MenuDivider, SubMenu, icons, shortcuts, badges, and infinite nesting. Automatically flips to stay within viewport bounds.',
            },
        },
    },
    tags: ['autodocs'],
            ...
            return (
                <div style={{ padding: 'var(--bk-spacing-8)' }}>
                    ...
                    >
                        ...
                        >
                            Last Action:{' '}
                            <strong style={{ color: 'var(--bk-color-foreground)' }}>
                                {lastAction}
                            </strong>
                        </div>
                        <div
                        ...
                        >
                            Total Actions:{' '}
                            <strong style={{ color: 'var(--bk-color-foreground)' }}>{count}</strong>
                        </div>
                        <div
                            style={{
                                fontSize: 'var(--bk-font-size-sm)',
            ...
            <ContextMenu
                menu={
                    <>
                        ...
                        <MenuItem icon={<Icon name="symbol-method" />}>Go to Definition</MenuItem>
                        <MenuItem icon={<Icon name="references" />}>Find All References</MenuItem>
                        <MenuDivider />
                        <MenuItem
