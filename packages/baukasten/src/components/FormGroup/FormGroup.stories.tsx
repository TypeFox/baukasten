...
const meta = {
    ...
    parameters: {
        docs: {
            description: {
                component:
                    'A flexible form field container supporting VSCode-style horizontal layout and traditional vertical layout. Use with FieldLabel and FormHelper for complete form fields.',
            },
        },
    },
    tags: ['autodocs'],
                            ...
                            <Select
                                ...
                                options={[
                                    ...
                                    },
                                    {
                                        value: 'manager',
                                        label: 'Manager',
                                        description: 'Lead teams and projects',
                                    },
                                ]}
        ...
        <div style={{ padding: '3rem', maxWidth: '1200px', margin: '0 auto' }}>
            ...
            <section style={{ marginTop: '3rem' }}>
                ...
                <form style={{ marginTop: '1.5rem' }}>
                    <FormGroup>
                        <FieldLabel htmlFor="showcase-1" required>
                            Name
                        </FieldLabel>
                    ...
                    <FormGroup>
                        <FieldLabel htmlFor="showcase-2" required>
                            Email
                        </FieldLabel>
                        <div>
                            <Input
            ...
            <section style={{ marginTop: '3rem' }}>
                ...
                <form style={{ marginTop: '1.5rem', maxWidth: '600px' }}>
                    <FormGroup orientation="vertical">
                        <FieldLabel htmlFor="showcase-v1" required>
                            Subject
                        </FieldLabel>
                    ...
                    <FormGroup orientation="vertical">
                        <FieldLabel htmlFor="showcase-v2" required>
                            Message
                        </FieldLabel>
                        <div>
                            <TextArea
