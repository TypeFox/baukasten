...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component:
                    'Groups buttons together with connected styling. Useful for creating toolbars, segmented controls, and split buttons. Supports a compositional API where buttons can be grouped naturally or combined with ButtonGroup.Dropdown for split button patterns.',
            },
        },
    },
    tags: ['autodocs'],
                        ...
                        <ButtonGroup.Dropdown
                            ...
                            content={
                                <Menu>
                                    ...
                                    <MenuItem onClick={() => console.log('Option 3')}>
                                        Option 3
                                    </MenuItem>
                                </Menu>
                            }
