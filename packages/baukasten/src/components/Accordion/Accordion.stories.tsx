...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component:
                    'A collapsible content panel component. Stack multiple AccordionItems together for a clean, organized interface. Supports exclusive mode (only one open at a time), icons, and disabled states. Fully integrates with VSCode/Theia theme variables.',
            },
        },
    },
    tags: ['autodocs'],
    ...
    render: (args) => (
        <Accordion {...args} style={{ width: '500px' }}>
            <AccordionItem id="section-1" title="Introduction">
                <Paragraph>
                    Welcome to Baukasten! This is a UI component library designed specifically for
                    VSCode webviews. It provides a consistent look and feel that matches VSCode's
                    native interface.
                </Paragraph>
            </AccordionItem>
            <AccordionItem id="section-2" title="Getting Started">
                <Paragraph>
                    To get started, install the package and import the components you need. Don't
                    forget to include the <Code>GlobalStyles</Code> component at the root of your
                    app.
                </Paragraph>
            </AccordionItem>
            <AccordionItem id="section-3" title="Documentation">
                <Paragraph>
                    ...
                    Check out the different stories to see all available features and usage
                    patterns.
                </Paragraph>
            </AccordionItem>
        </Accordion>
    ...
    render: () => (
        <Accordion style={{ width: '500px' }}>
            <AccordionItem title="What is Baukasten?">
                <Paragraph>
                    Baukasten is a React component library for building VSCode webview UIs. It
                    provides pre-built components that match VSCode's native look and feel.
                </Paragraph>
            </AccordionItem>
            <AccordionItem title="Why use Baukasten?">
                <Paragraph>
                    Building custom UIs for VSCode extensions can be time-consuming. Baukasten
                    speeds up development by providing ready-to-use components with proper theming.
                </Paragraph>
            </AccordionItem>
    ...
    render: () => (
        <Accordion exclusive defaultOpen="performance" style={{ width: '500px' }}>
            <AccordionItem id="performance" title="Performance">
                <Paragraph>
                    Baukasten components are optimized for performance with minimal re-renders and
                    efficient styling using vanilla-extract CSS-in-TypeScript.
                </Paragraph>
            </AccordionItem>
            ...
            <AccordionItem id="accessibility" title="Accessibility">
                <Paragraph>
                    Built with accessibility in mind. All components follow ARIA best practices and
...
export const WithIcons: Story = {
    render: () => (
        <Accordion style={{ width: '500px' }}>
            <AccordionItem title="General Settings" icon={<Icon name="gear" />} defaultOpen>
                <Paragraph>
                    Configure general application settings including language, theme preferences,
                    and defaults.
                </Paragraph>
            </AccordionItem>
            <AccordionItem title="Notifications" icon={<Icon name="bell" />}>
                <Paragraph>
                    Manage notification preferences and alerts. Choose which events trigger
                    notifications.
                </Paragraph>
            </AccordionItem>
            <AccordionItem title="Security" icon={<Icon name="shield" />}>
                <Paragraph>
                    Security settings including authentication, permissions, and data protection
                    options.
                </Paragraph>
            </AccordionItem>
            <AccordionItem title="Extensions" icon={<Icon name="extensions" />}>
                <Paragraph>
                    Manage installed extensions, browse marketplace, and configure extension
                    settings.
                </Paragraph>
            </AccordionItem>
        </Accordion>
...
export const CustomTitles: Story = {
    render: () => (
        <Accordion style={{ width: '600px' }}>
            ...
            >
                <Paragraph>
                    This section contains deprecated features that will be removed in the next major
                    version.
                </Paragraph>
            </AccordionItem>
        </Accordion>
    ...
    render: () => (
        <Accordion style={{ width: '600px' }}>
            <AccordionItem title="Installation Guide" defaultOpen>
                ...
                >
                    <li style={{ marginBottom: 'var(--bk-spacing-1)' }}>
                        <Text>
                            Install the package: <Code>npm install baukasten</Code>
                        </Text>
                    </li>
                    <li style={{ marginBottom: 'var(--bk-spacing-1)' }}>
                    ...
                    <li style={{ marginBottom: 'var(--bk-spacing-1)' }}>
                        <Text>
                            Add <Code>GlobalStyles</Code> to your root component
                        </Text>
                    </li>
                </ol>
            ...
            <AccordionItem title="API Reference" icon={<Icon name="symbol-method" />}>
                <Heading level={4} marginBottom>
                    Available Props
                </Heading>
                <ul style={{ paddingLeft: 'var(--bk-spacing-4)', lineHeight: '1.6' }}>
                    <li style={{ marginBottom: 'var(--bk-spacing-1)' }}>
                        <Text>
                            <Text weight="bold">title</Text>: React.ReactNode - The accordion header
                            content
                        </Text>
                    </li>
                    <li style={{ marginBottom: 'var(--bk-spacing-1)' }}>
                        <Text>
                            <Text weight="bold">defaultOpen</Text>: boolean - Whether the item is
                            open by default
                        </Text>
                    </li>
                    <li style={{ marginBottom: 'var(--bk-spacing-1)' }}>
                        <Text>
                            <Text weight="bold">disabled</Text>: boolean - Whether the item is
                            disabled
                        </Text>
                    </li>
                    <li style={{ marginBottom: 'var(--bk-spacing-1)' }}>
                        <Text>
                            <Text weight="bold">icon</Text>: React.ReactNode - Optional icon to
                            display
                        </Text>
                    </li>
                </ul>
            ...
            <AccordionItem title="Examples" icon={<Icon name="code" />}>
                <Paragraph>
                    Check out the Storybook for interactive examples and code snippets. Each story
                    demonstrates a different use case and pattern.
                </Paragraph>
            </AccordionItem>
        </Accordion>
    ),
...
export const LargeContent: Story = {
    render: () => (
        <Accordion style={{ width: '600px' }}>
            <AccordionItem title="Terms of Service" icon={<Icon name="law" />} defaultOpen>
                <Heading level={4} marginBottom>
                ...
                <Paragraph>
                    In no event shall Baukasten or its suppliers be liable for any damages
                ...
                <Paragraph>
                    ...
                    accurate, complete, or current. We may make changes to the materials at any time
                    without notice.
                </Paragraph>
            ...
            <AccordionItem title="Privacy Policy" icon={<Icon name="shield" />}>
                ...
                <Paragraph>
                    ...
                    newsletter, respond to a survey, fill out a form, or use certain features of our
                    service.
                </Paragraph>
                <Paragraph>
                ...
                >
                    <li style={{ marginBottom: 'var(--bk-spacing-1)' }}>
                        <Text>
                            To personalize your experience and deliver content tailored to your
                            interests
                        </Text>
                    </li>
                    <li style={{ marginBottom: 'var(--bk-spacing-1)' }}>
                ...
                <Paragraph>
                    ...
                    personal information. All supplied sensitive/credit information is transmitted
            ...
            <AccordionItem title="Frequently Asked Questions" icon={<Icon name="question" />}>
                ...
                <Paragraph>
                    Baukasten is a comprehensive React component library specifically designed for
                    building VSCode webview extensions. It provides a complete set of UI components
                    that seamlessly integrate with VSCode's theming system, making it easy to create
                    professional and consistent user interfaces for your extensions.
                </Paragraph>
                ...
                <Paragraph>
                    Then import the components you need in your React application and don't forget
                    to include the GlobalStyles component at the root of your application to ensure
                ...
                <Paragraph>
                    Yes! Baukasten is built with TypeScript and provides comprehensive type
                    definitions for all components, props, and utilities. This gives you excellent
                    autocomplete support and type safety when building your applications.
                </Paragraph>

                <Heading level={4} marginBottom>
                    Can I use this outside of VSCode?
                </Heading>
                <Paragraph>
                    While Baukasten is optimized for VSCode webviews, you can also use it in regular
                    web applications. We provide a VSCodeThemeWrapper component that simulates the
                    VSCode theming environment for browser-based applications and Storybook demos.
                </Paragraph>
            </AccordionItem>
        </Accordion>
    ),
            ...
            <div>
                ...
                <Accordion style={{ width: '600px' }}>
                    <AccordionItem title="Section 1" defaultOpen>
                        <Paragraph>
                            Content for the first section. Multiple sections can be open at the same
                            time.
                        </Paragraph>
                    </AccordionItem>
                    <AccordionItem title="Section 2">
                        <Paragraph>Content for the second section.</Paragraph>
                    </AccordionItem>
                    <AccordionItem title="Section 3">
                        <Paragraph>Content for the third section.</Paragraph>
                    </AccordionItem>
                </Accordion>
            </div>
            ...
            <div>
                ...
                <Accordion exclusive defaultOpen="opt-1" style={{ width: '600px' }}>
                    ...
                    <AccordionItem id="opt-3" title="Option 3">
                        <Paragraph>Great for wizards, FAQs, or settings panels.</Paragraph>
                    </AccordionItem>
                </Accordion>
            </div>
            ...
            <div>
                ...
                <Accordion style={{ width: '600px' }}>
                    <AccordionItem title="Files" icon={<Icon name="file" />}>
                        <Paragraph>Manage your project files and folders.</Paragraph>
                    </AccordionItem>
                    <AccordionItem title="Search" icon={<Icon name="search" />}>
                        <Paragraph>Search across your entire workspace.</Paragraph>
                    </AccordionItem>
                    <AccordionItem title="Settings" icon={<Icon name="gear" />}>
                        <Paragraph>Configure application preferences.</Paragraph>
                    </AccordionItem>
                </Accordion>
            </div>
            ...
            <div>
                ...
                <Accordion style={{ width: '600px' }}>
                    <AccordionItem
                        ...
                        defaultOpen
                    >
                        <Paragraph>Latest features with icons and badges in the title.</Paragraph>
                    </AccordionItem>
                    <AccordionItem
                        title={
                            <div
                    ...
                    >
                        <Paragraph>Experimental features with warning badges.</Paragraph>
                    </AccordionItem>
                </Accordion>
            </div>
            ...
            <div>
                ...
                <Accordion style={{ width: '600px' }}>
                    <AccordionItem
                        ...
                        defaultOpen
                    >
                        <Paragraph>This feature is ready to use.</Paragraph>
                    </AccordionItem>
                    ...
                    <AccordionItem
                        ...
                        disabled
                    >
                        <Paragraph>Upgrade to access this feature.</Paragraph>
                    </AccordionItem>
                </Accordion>
            </div>
        </div>
