...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component:
                    'A versatile menu component system for creating dropdown menus, context menus, and navigation menus. Includes MenuItem for clickable items, MenuDivider for separators, and SubMenu for nested hierarchies. Fully integrates with the design system and supports icons, badges, shortcuts, and infinite nesting.',
            },
        },
    },
    tags: ['autodocs'],
        ...
        >
            <div>
                ...
                <Menu>
                    ...
                    <MenuItem icon={<Icon name="clippy" />} rightContent="⌘V">
                        Paste
                    </MenuItem>
                    <MenuDivider />
            ...
            <div>
                ...
                <Menu>
                    ...
                    <MenuItem icon={<Icon name="mail" />} rightContent={<Badge size="xs">5</Badge>}>
                        Unread
                    </MenuItem>
                    <MenuItem
            ...
            <div>
                ...
                <Menu>
                    <MenuItem icon={<Icon name="file" />} rightContent="New">
                        Create Document
                    </MenuItem>
                    <MenuItem
                        icon={<Icon name="folder" />}
                        rightContent={
                            <span style={{ fontSize: '0.75em', opacity: 0.7 }}>Recent</span>
                        }
                    >
                        Open Folder
                    </MenuItem>
                    <MenuItem icon={<Icon name="star-full" />} rightContent={<Icon name="lock" />}>
                        Favorites
                    </MenuItem>
                </Menu>
            </div>
        ...
        >
            ...
            <div>
                ...
                <Menu>
                    ...
                    <MenuItem icon={<Icon name="debug-alt" />} disabled>
                        Disabled
                    </MenuItem>
...
export const WithDropdown: Story = {
    ...
    render: () => (
        ...
        >
            ...
            <Dropdown trigger={<Button>File Menu</Button>} placement="bottom-start">
                <Menu>
