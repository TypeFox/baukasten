...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component:
                    "A flexible dropdown component that displays user-defined content when triggered. Unlike Select, this component doesn't handle form state and allows any custom content in the dropdown menu. Perfect for action menus, user profiles, forms, and complex UI patterns. Supports click outside to close, Escape key handling, and multiple placement options.",
            },
        },
    },
    tags: ['autodocs'],
...
export const DisabledState: Story = {
    ...
    render: () => (
        <div style={{ display: 'flex', gap: 'var(--bk-gap-md)', alignItems: 'center' }}>
            <Dropdown trigger={<Button>Enabled</Button>}>
                <Menu>
            ...
            <Dropdown trigger={<Button>Disabled</Button>} disabled>
                <Menu>
...
export const CloseOnClickBehavior: Story = {
    ...
    render: () => (
        ...
        >
            ...
            <Dropdown trigger={<Button>Default (Closes)</Button>} closeOnClick={true}>
                <Menu>
                    <MenuItem icon={<Icon name="check" />}>Action 1</MenuItem>
                    <MenuItem icon={<Icon name="check" />}>Action 2</MenuItem>
                    <MenuItem icon={<Icon name="check" />}>Action 3</MenuItem>
            ...
            <Dropdown trigger={<Button>Stays Open</Button>} closeOnClick={false}>
        ...
        >
                ...
                >
                    ...
                    >
                        <Menu size="sm">
                            ...
                            <MenuItem
                                icon={<Icon name="bell" />}
                                rightContent={<Badge variant="error">3</Badge>}
                            >
                                Alerts
                            </MenuItem>
                        </Menu>
            ...
            <section>
                ...
                >
                    ...
                    <Dropdown
                        trigger={
                            <Button variant="ghost" circular size="sm">
                                <Icon name="ellipsis" />
                            </Button>
                        }
                    >
            ...
            <section>
                ...
                <div style={{ display: 'flex', gap: 'var(--bk-gap-md)', alignItems: 'center' }}>
                    <Dropdown trigger={<Button size="sm">Enabled</Button>}>
                        <Menu size="sm">
                            <MenuItem>Normal dropdown</MenuItem>
                        </Menu>
                    </Dropdown>
