...
globalStyle(`${tab.classNames.base}${lineIndicatorHorizontalEnd}[data-active="true"]::after`, {
    backgroundColor: 'var(--bk-color-primary)',
});
...
globalStyle(`${tab.classNames.base}${lineIndicatorHorizontalStart}[data-active="true"]::after`, {
    backgroundColor: 'var(--bk-color-primary)',
});
...
globalStyle(`${tab.classNames.base}${lineIndicatorVerticalEnd}[data-active="true"]::after`, {
    backgroundColor: 'var(--bk-color-primary)',
});
...
globalStyle(`${tab.classNames.base}${lineIndicatorVerticalStart}[data-active="true"]::after`, {
    backgroundColor: 'var(--bk-color-primary)',
});
...
globalStyle(`${tab.classNames.base}${liftedHorizontalEnd}[data-active="true"]`, {
    borderBottom: 'none',
});

globalStyle(`${tab.classNames.base}${liftedHorizontalEnd}[data-active="true"]::before`, {
    content: '',
    position: 'absolute',
    bottom: '-1px',
    left: 0,
...
globalStyle(`${tab.classNames.base}${liftedHorizontalStart}[data-active="true"]`, {
    borderTop: 'none',
});

globalStyle(`${tab.classNames.base}${liftedHorizontalStart}[data-active="true"]::before`, {
    content: '',
    position: 'absolute',
    top: '-1px',
    left: 0,
...
globalStyle(`${tab.classNames.base}${liftedVerticalEnd}[data-active="true"]::before`, {
    content: '',
    position: 'absolute',
    right: '-1px',
    top: 0,
...
globalStyle(`${tab.classNames.base}${liftedVerticalStart}[data-active="true"]`, {
    borderLeft: 'none',
});

globalStyle(`${tab.classNames.base}${liftedVerticalStart}[data-active="true"]::before`, {
    content: '',
    position: 'absolute',
    left: '-1px',
    top: 0,
