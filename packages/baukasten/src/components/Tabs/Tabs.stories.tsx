...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component:
                    'A tabbed interface component following VSCode design patterns. Supports horizontal and vertical orientations, icons, closable tabs, and both controlled and uncontrolled modes. Perfect for organizing content into separate views.',
            },
        },
    },
    tags: ['autodocs'],
            ...
            <div>
                ...
                >
                    <Tabs defaultValue="tab1" variant="line">
                        ...
                        <TabPanels>
                            <TabPanel value="tab1">
                                Clean line indicator at the bottom. Minimal VSCode-style design.
                            </TabPanel>
            ...
            <div>
                ...
                >
                    <Tabs defaultValue="tab1" variant="lifted">
                        ...
                        <TabPanels>
                            <TabPanel value="tab1">
                                Active tab has a border around it that connects to the content area.
                            </TabPanel>
                            <TabPanel value="tab2">
                                Creates a "lifted" effect where the tab appears to pop out.
                            </TabPanel>
            ...
            <div>
                ...
                >
                    <Tabs defaultValue="tab1" variant="pills">
                        ...
                        <TabPanels>
                            <TabPanel value="tab1">
                                No borders, just subtle rounded corners like tags.
                            </TabPanel>
                            <TabPanel value="tab2">
                                Active tab has a filled background with primary color.
                            </TabPanel>
                            <TabPanel value="tab3">
                                Modern, clean appearance perfect for contemporary UIs.
                            </TabPanel>
                        </TabPanels>
                    </Tabs>
                </div>
            ...
            <Tabs defaultValue="file1">
                ...
                <TabPanels>
                    <TabPanel value="file1">
                        <div
                            style={{ fontFamily: 'monospace', fontSize: 'var(--bk-font-size-sm)' }}
                        >
                            <div style={{ color: 'var(--bk-color-foreground-muted)' }}>
                                // index.tsx
                            </div>
                        ...
                        <TabPanels>
                            {tabs.map((tab) => (
                                <TabPanel key={tab.value} value={tab.value}>
                                    <h3>{tab.label}</h3>
                                    <p>
                                        Content for {tab.label}. Click the close button (×) to
                                        remove this tab.
                                    </p>
                                </TabPanel>
                            ))}
                ...
                >
                    <Tabs defaultValue="general">
                        <TabList>
                            ...
                            <Tab value="extensions" icon="extensions">
                                Extensions
                            </Tab>
                        </TabList>
                        <TabPanels>
                ...
                >
                    <Tabs defaultValue="files">
                        <TabList>
                            ...
                            <Tab value="search" icon="search">
                                Search
                            </Tab>
                            <Tab value="git" icon="source-control">
                                Source Control
                            </Tab>
                            <Tab value="debug" icon="debug-alt">
                                Debug
                            </Tab>
                        </TabList>
                        <TabPanels>
            ...
            <div>
                ...
                >
                    <Tabs defaultValue="account" orientation="vertical">
                        <TabList>
                            <Tab value="account" icon="account">
                                Account
                            </Tab>
