...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component:
                    'A versatile checkbox component that supports both traditional checkbox and toggle switch styles. Use with the Label component (variant="checkbox") for accessible labels. Includes support for indeterminate state and all standard input attributes. Fully integrates with VSCode/Theia theme variables for consistent theming.',
            },
        },
    },
    tags: ['autodocs'],
    ...
    render: () => (
        ...
        >
            <Label variant="checkbox" size="md">
                ...
                <span>
                    This is a very long label that will wrap to multiple lines and maintain proper
                    alignment with the checkbox. The text wraps naturally below the first line.
                </span>
            </Label>
            <Label variant="checkbox" size="md">
                <Checkbox variant="switch" name="multiline-2" id="multiline-switch" />
                <span>
                    This switch has a long label that demonstrates how multiline text is handled.
                    Notice how the text wraps and stays aligned naturally.
                </span>
            </Label>
            <Label variant="checkbox" size="lg">
                <Checkbox size="lg" name="multiline-3" id="multiline-large" />
                <span>
                    Large checkbox with a multiline label. The font size automatically scales with
                    the checkbox size for visual harmony.
                </span>
            </Label>
        </div>
    ),
            ...
            <div>
                ...
                >
                    <Label variant="checkbox" size="md">
                        <Checkbox />
                        <span>
                            This is a very long label that will wrap to multiple lines and maintain
                            proper alignment with the checkbox.
                        </span>
                    </Label>
                    <Label variant="checkbox" size="md">
                        <Checkbox variant="switch" />
                        <span>
                            This switch has a long label that demonstrates how multiline text is
                            handled with proper alignment.
                        </span>
                    </Label>
                </div>
            </div>
