...
export const checkboxIndicator = recipe({
    ...
    compoundVariants: [
        ...
        {
            variants: { variant: 'checkbox', size: 'xs' },
            style: {
        ...
        {
            variants: { variant: 'checkbox', size: 'sm' },
            style: {
        ...
        {
            variants: { variant: 'checkbox', size: 'md' },
            style: {
        ...
        {
            variants: { variant: 'checkbox', size: 'lg' },
            style: {
        ...
        {
            variants: { variant: 'checkbox', size: 'xl' },
            style: {
        ...
        {
            variants: { variant: 'switch', size: 'xs' },
            style: {
                width: 'var(--bk-spacing-5)',
                height: 'var(--bk-spacing-3)',
                minWidth: 'var(--bk-spacing-5)',
        ...
        {
            variants: { variant: 'switch', size: 'sm' },
            style: {
                width: 'var(--bk-spacing-6)',
                height: 'var(--bk-spacing-3-5)',
                minWidth: 'var(--bk-spacing-6)',
        ...
        {
            variants: { variant: 'switch', size: 'md' },
            style: {
                width: 'var(--bk-spacing-7)',
                height: 'var(--bk-spacing-4)',
                minWidth: 'var(--bk-spacing-7)',
            },
        },
        {
            variants: { variant: 'switch', size: 'lg' },
            style: {
                width: 'var(--bk-spacing-9)',
                height: 'var(--bk-spacing-5)',
                minWidth: 'var(--bk-spacing-9)',
            },
        },
        {
            variants: { variant: 'switch', size: 'xl' },
            style: {
...
export const switchThumb = recipe({
    ...
    compoundVariants: [
        // Transform values per size when checked
        {
            ...
            style: {
                transform:
                    'translateX(calc(var(--bk-spacing-5) - var(--bk-spacing-2) - 2 * var(--bk-spacing-0-5) - var(--bk-border-width-1)))',
            },
        },
        {
            ...
            style: {
                transform:
                    'translateX(calc(var(--bk-spacing-6) - var(--bk-spacing-2-5) - 2 * var(--bk-spacing-0-5) - var(--bk-border-width-1)))',
            },
        },
        {
            ...
            style: {
                transform:
                    'translateX(calc(var(--bk-spacing-7) - var(--bk-spacing-3) - 2 * var(--bk-spacing-0-5) - var(--bk-border-width-1)))',
            },
        },
        {
            ...
            style: {
                transform:
                    'translateX(calc(var(--bk-spacing-9) - var(--bk-spacing-4) - 2 * var(--bk-spacing-0-5) - var(--bk-border-width-1)))',
            },
        },
        {
            ...
            style: {
                transform:
                    'translateX(calc(var(--bk-spacing-10) - var(--bk-spacing-5) - 2 * var(--bk-spacing-0-5) - var(--bk-border-width-1)))',
            },
        },
    ],
