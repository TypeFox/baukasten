...
export const Table: React.FC<TableProps> & {
    ...
    const table = (
        <table className={clsx(styles.table({ fullWidth, bordered }), className)} {...props}>
    ...
    return <TableContext.Provider value={contextValue}>{table}</TableContext.Provider>;
};

/**
 * Table Head component
 */
const TableHead: React.FC<TableHeadProps> = ({ sticky = false, children, className, ...props }) => {
 ...
 */
const TableCell: React.FC<TableCellProps> = ({ align = 'left', children, className, ...props }) => {
