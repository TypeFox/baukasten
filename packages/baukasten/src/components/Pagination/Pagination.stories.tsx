...
export const States: Story = {
    render: () => {
        const StateExample = ({
            label,
            ...props
        }: { label: string } & React.ComponentProps<typeof Pagination>) => {
        ...
        return (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--bk-gap-xl)' }}>
                <StateExample label="First Page" totalItems={100} currentPage={1} pageSize={10} />
                <StateExample label="Middle Page" totalItems={100} currentPage={5} pageSize={10} />
                <StateExample label="Last Page" totalItems={100} currentPage={10} pageSize={10} />
                <StateExample label="Single Page" totalItems={5} currentPage={1} pageSize={10} />
                <StateExample
                        ...
                        <tbody>
                            {paginatedData.map((item) => (
                                ...
                                >
                                    ...
                                    <td style={{ padding: 'var(--bk-spacing-2)' }}>
                                        {item.category}
                                    </td>
                                    <td
                                        style={{
    ...
    render: () => {
        ...
        return (
            <div style={{ padding: 'var(--bk-spacing-6)' }}>
                ...
                >
                    Navigate through pages of data with smart controls and optional page size
                    selection.
                </p>
