    ...
    variants: {
        size: {
            xs: {
                ...
                minWidth:
                    'calc(var(--bk-font-size-xs) * var(--bk-line-height-tight) + 2 * var(--bk-spacing-0-5) + 2 * var(--bk-border-width-1))',
            },
            sm: {
                ...
                lineHeight: 'var(--bk-line-height-tight)',
                minWidth:
                    'calc(var(--bk-font-size-sm) * var(--bk-line-height-tight) + 2 * var(--bk-spacing-0-5) + 2 * var(--bk-border-width-1))',
            },
            md: {
                ...
                minWidth:
                    'calc(var(--bk-font-size-sm) * var(--bk-line-height-normal) + 2 * var(--bk-spacing-1) + 2 * var(--bk-border-width-1))',
            },
            lg: {
                ...
                lineHeight: 'var(--bk-line-height-normal)',
                minWidth:
                    'calc(var(--bk-font-size-md) * var(--bk-line-height-normal) + 2 * var(--bk-spacing-1-5) + 2 * var(--bk-border-width-1))',
            },
            xl: {
                ...
                lineHeight: 'var(--bk-line-height-normal)',
                minWidth:
                    'calc(var(--bk-font-size-base) * var(--bk-line-height-normal) + 2 * var(--bk-spacing-2) + 2 * var(--bk-border-width-1))',
            },
        },
