...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component:
                    'A small status indicator or label component with multiple variants and sizes. Supports icons and uses design system tokens for consistent theming.',
            },
        },
    },
    tags: ['autodocs'],
    ...
    render: () => (
        ...
        >
            ...
            <div>
                ...
                >
                    <Badge variant="error" outline size="xs">
                        XS
                    </Badge>
                    <Badge variant="error" outline size="sm">
                        SM
                    </Badge>
                    <Badge variant="error" outline size="md">
                        MD
                    </Badge>
                    <Badge variant="error" outline size="lg">
                        LG
                    </Badge>
                    <Badge variant="error" outline size="xl">
                        XL
                    </Badge>
                </div>
            </div>
