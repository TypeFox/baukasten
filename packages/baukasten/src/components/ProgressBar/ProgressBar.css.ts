...
export const progressBarFill = recipe({
    ...
    variants: {
        ...
        striped: {
            true: {
                backgroundImage:
                    'linear-gradient(45deg, var(--bk-color-stripe-overlay) 25%, transparent 25%, transparent 50%, var(--bk-color-stripe-overlay) 50%, var(--bk-color-stripe-overlay) 75%, transparent 75%, transparent)',
