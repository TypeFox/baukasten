...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component:
                    'A progress indicator component for showing task completion or loading states. Supports determinate (with value) and indeterminate (loading) modes. Includes VSCode-style shimmer animation for loading states, striped patterns, and multiple semantic variants.',
            },
        },
    },
    tags: ['autodocs'],
