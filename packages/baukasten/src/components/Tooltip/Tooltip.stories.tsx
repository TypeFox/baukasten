...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component:
                    'A hover-triggered tooltip component that wraps a trigger element and displays informational content. Supports 12 placements and multiple variants with an optional arrow. Perfect for providing contextual help and information.',
            },
        },
    },
    tags: ['autodocs'],
            ...
            <Tooltip
                content={
                    ...
                    >
                        ...
                        >
                            This is a longer information message that demonstrates how content wraps
                            within the tooltip.
                        </p>
                    </div>
                }
