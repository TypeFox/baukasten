...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component:
                    "A navigation component that shows the user's current location within the application hierarchy. Supports custom separators, sizing, icons, and automatic item collapsing for long paths.",
            },
        },
    },
    tags: ['autodocs'],
