...
const meta = {
    ...
    argTypes: {
        ...
        background: {
            ...
            description:
                'Background color using semantic tokens (default, secondary, tertiary, elevated)',
            table: {
        ...
        children: {
            control: false,
            description:
                'Optional children rendered below title and description. Perfect for CTA buttons or additional content.',
            table: {
                type: { summary: 'ReactNode' },
            },
        },
...
export const Interactive: Story = {
    args: {
        ...
        description:
            'A comprehensive UI toolkit for VSCode webviews built with React and TypeScript',
        align: 'left',
        size: 'md',
        background: 'default',
    },
    parameters: {
        docs: {
            description: {
                story: 'Interactive playground to explore all Hero component properties. Adjust the title, description, alignment, size, and background to see how they affect the component.',
            },
        },
    },
};
...
export const Sizes: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: 'Hero component supports five size variants: sm (20vh), md (40vh), lg (60vh), xl (80vh), and full (100vh). The size prop controls the minimum height of the hero section.',
            },
        },
    },
};
...
export const Alignments: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: 'The align prop controls text alignment within the hero. Choose from left (default), center, or right alignment to match your design needs.',
            },
        },
    },
};
...
export const Backgrounds: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: 'The background prop accepts semantic color tokens (default, secondary, tertiary, elevated) that automatically adapt to the VSCode theme. Each background level corresponds to different VSCode UI areas.',
            },
        },
    },
};
...
export const WithCTA: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: 'Hero component supports children rendered below the title and description. This example shows a typical landing page hero with centered text and CTA buttons passed as children. Perfect for adding buttons, links, or any additional content.',
            },
        },
    },
};
...
export const FullViewport: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: 'A full viewport height (100vh) hero perfect for splash screens, landing pages, or when you want maximum visual impact. The size="full" prop creates an immersive first impression.',
            },
        },
    },
};
...
export const TitleOnly: Story = {
    args: { title: '' },
    render: () => <Hero title="Simple. Powerful. Beautiful." align="center" size="md" />,
    parameters: {
        docs: {
            description: {
                story: 'Hero component works beautifully with just a title. Omit the description prop for a minimal, focused design.',
            },
        },
    },
};
...
export const SectionHeader: Story = {
        ...
        <div>
            ...
            <div style={{ padding: 'var(--bk-spacing-6)' }}>
                <p style={{ color: 'var(--bk-color-foreground)' }}>
                    Your content goes here. The hero component works great as a section divider or
                    category header within your application.
                </p>
            </div>
        </div>
    ),
    parameters: {
        docs: {
            description: {
                story: 'Hero component with size="sm" works well as a section header within your application, providing visual hierarchy and clear content separation.',
            },
        },
    },
};
...
const ShowcaseSection = ({ children }: { children: React.ReactNode }) => (
    <div style={{ marginBottom: 'var(--bk-spacing-2)' }}>{children}</div>
);
...
export const Showcase: Story = {
    ...
    render: () => (
        <div>
            ...
            <ShowcaseSection>
                <Hero title="Minimal Hero" align="center" size="sm" background="default" />
            </ShowcaseSection>
        </div>
    ),
    parameters: {
        docs: {
            description: {
                story: 'Complete showcase demonstrating all Hero component capabilities including various sizes (sm to full), alignments (left, center, right), backgrounds (default, secondary, tertiary, elevated), and practical use cases like landing pages, section headers, and CTAs with children.',
            },
        },
    },
};
