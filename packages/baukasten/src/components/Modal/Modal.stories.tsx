...
const meta = {
    ...
    parameters: {
        docs: {
            description: {
                component:
                    'A flexible modal dialog component with support for different sizes, backdrop variants, and composable structure.',
            },
        },
    },
    tags: ['autodocs'],
        ...
        <div style={{ display: 'flex', gap: '1rem', padding: '2rem', flexWrap: 'wrap' }}>
            {sizes.map((size) => (
                <React.Fragment key={size}>
                    <Button onClick={() => setOpenModal(size)}>{size.toUpperCase()} Modal</Button>
                    <Modal open={openModal === size} onClose={() => setOpenModal(null)} size={size}>
                        ...
                        <ModalBody>
                            ...
                            <Paragraph>
                                Modal sizes help you choose the right dimensions for your content.
                            </Paragraph>
                        </ModalBody>
                        <ModalFooter>
    ...
    return (
        <div style={{ padding: '2rem' }}>
            ...
            <Modal open={isOpen} onClose={() => setIsOpen(false)} size="fullscreen">
                <ModalHeader onClose={() => setIsOpen(false)}>Fullscreen Preview</ModalHeader>
                <ModalBody>
                    <div
                        style={{
                            display: 'flex',
                    ...
                    >
                        ...
                        <Paragraph>
                            Perfect for media previews, image galleries, or complex forms.
                        </Paragraph>
                    </div>
                </ModalBody>
            </Modal>
    ...
    return (
        <div style={{ padding: '2rem' }}>
            ...
            >
                ...
                <ModalBody>
                    <Paragraph>
                        This modal uses the <Text weight="bold">{variant || 'solid'}</Text> backdrop
                        variant.
                    </Paragraph>
                    <ul style={{ margin: 0, paddingLeft: '1.5rem' }}>
                        <li>
                            <Text weight="bold">Solid</Text>: Dark semi-transparent background
                        </li>
                        <li>
                            <Text weight="bold">Blur</Text>: Blurred background with backdrop-filter
                        </li>
                        <li>
                            <Text weight="bold">Transparent</Text>: No visible backdrop (clicks
                            still work)
                        </li>
                    </ul>
                </ModalBody>
            ...
            >
                ...
                <Paragraph>
                    Open the modals above to see how different backdrop styles affect this content.
                </Paragraph>
...
const WithFormComponent = () => {
    ...
    const roleOptions = [
        ...
        { value: 'designer', label: 'Designer', description: 'UI/UX and visual design' },
        {
            ...
            description: 'Team and project coordination',
        },
    ...
    return (
        <div style={{ padding: '2rem' }}>
            ...
            <Modal open={isOpen} onClose={handleCancel} size="lg">
                <ModalHeader onClose={handleCancel}>Add New Team Member</ModalHeader>
                <ModalBody>
                        ...
                        <div>
                            ...
                            <FormGroup orientation="vertical">
                                ...
                                <div>
                                    ...
                                    {errors.role && (
                                        <FormHelper variant="error">{errors.role}</FormHelper>
                                    )}
    ...
    return (
        <div style={{ padding: '2rem' }}>
            ...
            <Modal open={isOpen} onClose={() => setIsOpen(false)} size="md">
                <ModalHeader onClose={() => setIsOpen(false)}>Terms and Conditions</ModalHeader>
                <ModalBody>
        ...
        >
            ...
            <section style={{ marginBottom: '3rem' }}>
                ...
                <Paragraph color="muted">
                    Available sizes: xs (400px), sm (500px), md (600px), lg (800px), xl (1000px),
                    fullscreen
                </Paragraph>
            ...
            <section style={{ marginBottom: '3rem' }}>
                ...
                <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
                    <Button size="sm" onClick={() => setActiveDemo('solid')}>
                        Solid
                    </Button>
                    <Button size="sm" onClick={() => setActiveDemo('blur')}>
                        Blur
                    </Button>
                    <Button size="sm" onClick={() => setActiveDemo('transparent')}>
                        Transparent
                    </Button>
                </div>
            </section>
            ...
            <section style={{ marginBottom: '3rem' }}>
                ...
                <Paragraph color="muted">Common modal patterns for different use cases</Paragraph>
                <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
                    <Button size="sm" onClick={() => setActiveDemo('form')}>
                        Form
                    </Button>
                    <Button size="sm" onClick={() => setActiveDemo('confirm')}>
                        Confirmation
                    </Button>
                    <Button size="sm" onClick={() => setActiveDemo('scroll')}>
                        Scrollable
                    </Button>
                    <Button size="sm" onClick={() => setActiveDemo('simple')}>
                        Simple
                    </Button>
                </div>
            </section>
            ...
            <Modal
                ...
                size="fullscreen"
            >
                <ModalHeader onClose={() => setActiveDemo(null)}>Fullscreen Modal</ModalHeader>
                <ModalBody>
                    <div
                        style={{
                            display: 'flex',
            ...
            {(['solid', 'blur', 'transparent'] as const).map((variant) => (
                ...
                >
                    ...
                    <ModalBody>
                        <Paragraph>
                            This modal uses the <Text weight="bold">{variant}</Text> backdrop
                            variant.
                        </Paragraph>
                    </ModalBody>
                    <ModalFooter>
            ...
            <Modal open={activeDemo === 'form'} onClose={() => setActiveDemo(null)}>
                <ModalHeader onClose={() => setActiveDemo(null)}>Form Example</ModalHeader>
                <ModalBody>
                ...
                <ModalFooter>
                    <Button variant="secondary" onClick={() => setActiveDemo(null)}>
                        Cancel
                    </Button>
                    <Button variant="primary" onClick={() => setActiveDemo(null)}>
                        Save
                    </Button>
                </ModalFooter>
            </Modal>

            <Modal open={activeDemo === 'confirm'} onClose={() => setActiveDemo(null)} size="sm">
                <ModalHeader onClose={() => setActiveDemo(null)}>Confirm Action</ModalHeader>
                <ModalBody>
            ...
            <Modal open={activeDemo === 'scroll'} onClose={() => setActiveDemo(null)}>
                <ModalHeader onClose={() => setActiveDemo(null)}>Scrollable Content</ModalHeader>
                <ModalBody>
                    {Array.from({ length: 20 }, (_, i) => (
                        <Paragraph key={i}>
            ...
            <Modal open={activeDemo === 'simple'} onClose={() => setActiveDemo(null)} size="sm">
                <ModalBody>
                    <div style={{ textAlign: 'center', padding: '1rem' }}>
                        <Heading level={3} marginBottom={false}>
                            Simple Modal
...
const WithSelectComponent = () => {
    ...
    return (
        <div style={{ padding: '2rem' }}>
            ...
            <Modal open={isOpen} onClose={() => setIsOpen(false)} size="md">
                <ModalHeader onClose={() => setIsOpen(false)}>User Preferences</ModalHeader>
                <ModalBody>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                        <FormGroup orientation="vertical">
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                        ...
                        <div>
                            ...
                            <FormGroup orientation="vertical">
                                ...
                                <div>
                                    ...
                                    />
                                    <FormHelper>
                                        Select dropdown should appear above the modal
                                    </FormHelper>
                                </div>
                            </FormGroup>
                        </div>
                        ...
                        <div>
                            ...
                            <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
                                ...
                                <Dropdown trigger={<Button variant="secondary">Options</Button>}>
                                    <Menu>
                                        <MenuItem icon={<Icon name="settings" />}>
                                            Settings
                                        </MenuItem>
                        ...
                        <div>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <Paragraph
                                        color="muted"
                                        style={{ fontSize: 'var(--bk-font-size-sm)' }}
                                    >
                        ...
                        >
                            ...
                            <Paragraph style={{ fontSize: 'var(--bk-font-size-sm)', margin: 0 }}>
                                All popup components (Select, Dropdown, ContextMenu) should appear
                                above the modal. This verifies that the z-index hierarchy is working
                                correctly.
                            </Paragraph>
                        </div>
                    </div>
