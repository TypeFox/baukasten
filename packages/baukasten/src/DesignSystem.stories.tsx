...
const SubsectionTitle = ({ children }: { children: React.ReactNode }) => (
    <h3 className="ds-subsection-title">{children}</h3>
);
const Description = ({ children }: { children: React.ReactNode }) => (
    <p className="ds-description">{children}</p>
);
...
const TokenCard = ({ children }: { children: React.ReactNode }) => (
    <div className="ds-token-card">{children}</div>
);
const TokenName = ({ children }: { children: React.ReactNode }) => (
    <div className="ds-token-name">{children}</div>
);
const TokenValue = ({
    children,
    style,
    ...
    <div className="ds-token-value" style={style}>
        {children}
    </div>
);
...
const SpacingBox = ({ size }: { size: string }) => (
    <div className="ds-spacing-box" style={{ width: size, height: size }} />
);
const GapDemo = ({ gap, children }: { gap: string; children: React.ReactNode }) => (
    <div className="ds-gap-demo" style={{ gap }}>
        {children}
    </div>
);
const GapItem = () => <div className="ds-gap-item" />;
const PaddingDemo = ({ padding, children }: { padding: string; children: React.ReactNode }) => (
    <div className="ds-padding-demo" style={{ padding }}>
        {children}
    </div>
);
const PaddingInner = ({ children }: { children: React.ReactNode }) => (
    <div className="ds-padding-inner">{children}</div>
);
const TextSample = ({
    size,
    weight,
    ...
    <div
        className="ds-text-sample"
        style={{ fontSize: size, fontWeight: weight || 'var(--bk-font-weight-normal)' }}
    >
        {children}
    </div>
);
const ShadowBox = ({ shadow, children }: { shadow: string; children: React.ReactNode }) => (
    <div className="ds-shadow-box" style={{ boxShadow: shadow }}>
        {children}
    </div>
);
const Code = ({ children }: { children: React.ReactNode }) => (
    <code className="ds-code">{children}</code>
);
        ...
        <>
            ...
            <Container>
                <Section>
                    ...
                    <Description>
                        Gap spacing used between flex/grid items. Visual demonstration shows spacing
                        between elements.
                    </Description>
                    <Grid columns={3}>
                        {gapTokens.map((token) => (
                    ...
                    <Description>
                        Padding for components. Visual demonstration shows padding around content
                        (outer gray box is padding space).
                    </Description>
                    <Grid columns={3}>
                    ...
                    <Grid columns={2}>
                        <TokenCard>
                            ...
                            <TokenValue style={{ marginTop: 'var(--bk-spacing-2)' }}>
                                <Code>--bk-size-xs</Code> (20px) through <Code>--bk-size-xl</Code>{' '}
                                (36px)
                            </TokenValue>
                        </TokenCard>
                        <TokenCard>
                            ...
                            <TokenValue style={{ marginTop: 'var(--bk-spacing-2)' }}>
                                <Code>--bk-size-circular-xs</Code> (24px) through{' '}
                                <Code>--bk-size-circular-xl</Code> (40px)
                            </TokenValue>
                        </TokenCard>
                    </Grid>
                </Section>
                ...
                <Section>
                    ...
                    <Grid columns={1}>
                        {typographyTokens.sizes.map((token) => (
                            <TokenCard key={token.name}>
                                <TextSample size={`var(${token.name})`}>{token.sample}</TextSample>
                                <TokenName>{token.name}</TokenName>
                                <TokenValue>{token.value}</TokenValue>
                            </TokenCard>
                        ))}
                    ...
                    <Grid columns={3}>
                        {typographyTokens.weights.map((token) => (
                            <TokenCard key={token.name}>
                                <TextSample
                                    size="var(--bk-font-size-base)"
                                    weight={`var(${token.name})`}
                                >
                                    The quick brown fox
                                </TextSample>
                                <TokenName>{token.name}</TokenName>
                    ...
                    <Grid columns={2}>
                        <TokenCard>
                            ...
                            <TokenValue style={{ marginTop: 'var(--bk-spacing-2)' }}>
                                <Code>--bk-line-height-tight</Code> (1.25)
                                <br />
                                <Code>--bk-line-height-normal</Code> (1.5)
                                <br />
                                <Code>--bk-line-height-relaxed</Code> (1.75)
                                <br />
                        ...
                        <TokenCard>
                            ...
                            <TokenValue style={{ marginTop: 'var(--bk-spacing-2)' }}>
                                <Code>--bk-letter-spacing-tight</Code>
                                <br />
                                <Code>--bk-letter-spacing-normal</Code>
                                <br />
                                <Code>--bk-letter-spacing-wide</Code>
                                <br />
                ...
                <Section>
                    ...
                    <Grid columns={2}>
                        <TokenCard>
                            ...
                            <TokenValue style={{ marginTop: 'var(--bk-spacing-2)' }}>
                                <Code>--bk-transition-fast</Code> (100ms)
                                <br />
                                <Code>--bk-transition-base</Code> (150ms)
                                <br />
                        ...
                        <TokenCard>
                            ...
                            <TokenValue style={{ marginTop: 'var(--bk-spacing-2)' }}>
                                <Code>--bk-transition-colors</Code>
                                <br />
                                <Code>--bk-transition-all</Code>
                                <br />
                                <Code>--bk-transition-transform</Code>
                                <br />
                    ...
                    <Grid columns={2}>
                        <TokenCard>
                            ...
                            <TokenValue style={{ marginTop: 'var(--bk-spacing-2)' }}>
                                <Code>--bk-opacity-disabled</Code> (0.4)
                                <br />
                                <Code>--bk-opacity-hover</Code> (0.8)
                                <br />
                                <Code>--bk-opacity-muted</Code> (0.6)
                                <br />
                                Scale from <Code>--bk-opacity-0</Code> to{' '}
                                <Code>--bk-opacity-100</Code>
                            </TokenValue>
                        </TokenCard>
                        <TokenCard>
                            <TokenName>Z-Index</TokenName>
                            <TokenValue style={{ marginTop: 'var(--bk-spacing-2)' }}>
                                <Code>--bk-z-index-dropdown</Code> (1000)
                                <br />
                                <Code>--bk-z-index-modal</Code> (1050)
                                <br />
                                <Code>--bk-z-index-tooltip</Code> (1070)
                                <br />
