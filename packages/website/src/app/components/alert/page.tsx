...
import { Alert, Icon } from 'baukasten-ui/core';
            ...
            <Showcase
                ...
                preview={
                    <div style={{ width: '100%', maxWidth: '600px' }}>
                        <Alert>
                            This is an informational alert that provides helpful information to
                            users.
                        </Alert>
                    </div>
                }
                code={`import { Alert } from 'baukasten-ui/core';
      ...
      This is an informational alert.
            ...
            <Showcase
                ...
                preview={
                    ...
                    >
                        <Alert variant="info">
                            This is an informational alert. Use it to provide helpful information to
                            users.
                        </Alert>
                        ...
                        <Alert variant="warning">
                            Please review your changes before proceeding. This action may have
                            consequences.
                        </Alert>
                        <Alert variant="error">
                ...
                preview={
                    ...
                    >
                        <Alert variant="info" title="Information">
                            This alert includes a title to provide additional context and structure
                            to the message.
                        </Alert>
  ...
  With callback on close
            ...
            <Showcase
                ...
                preview={
                    ...
                    >
                        <Alert variant="info" icon={<Icon name="lightbulb" />} title="Tip">
                            You can override the default icon with any custom icon you prefer.
                        </Alert>
                        <Alert variant="success" icon={<Icon name="rocket" />} title="Launched">
                            Your application has been successfully deployed to production!
                        </Alert>
                        <Alert variant="warning" icon={<Icon name="flame" />} title="Hot Feature">
                            This is a brand new feature that just launched. Try it out!
                        </Alert>
                        <Alert variant="error" icon={<Icon name="bug" />} title="Bug Report">
