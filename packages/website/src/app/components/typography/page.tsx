...
import { Heading, Text, Paragraph, Code, Link } from 'baukasten';
    ...
    return (
        ...
        >
            <Showcase
                ...
                code={`import { Heading } from 'baukasten';
...
<Heading level={2} align="right">Right Aligned</Heading>`}
            ...
            <Showcase
                ...
                code={`import { Text } from 'baukasten';
...
<Text block truncate style={{ maxWidth: '200px' }}>
  This is a very long text that will be truncated...
            ...
            <Showcase
                ...
                code={`import { Paragraph } from 'baukasten';
...
Line 10`}</Code>
                ...
                code={`import { Code, Text } from 'baukasten';
...
<Code block maxHeight="100px">
  {longCodeSnippet}
            ...
            <Showcase
                ...
                code={`import { Link, Paragraph } from 'baukasten';
...
function App() {
  return <Button>Click me</Button>;
                ...
                code={`import { Heading, Paragraph, Code, Link } from 'baukasten';
