  ...
  <p>Create a new account to get started</p>
            ...
            <Showcase
                ...
                preview={
                    ...
                    >
                        <div>
                            <Paragraph style={{ marginBottom: 'var(--bk-spacing-2)' }}>
                                Content before section
                            </Paragraph>
                            <Divider label="Getting Started" labelAlign="left" />
                            <Paragraph style={{ marginTop: 'var(--bk-spacing-2)' }}>
                        ...
                        <div>
                            ...
                            <Paragraph style={{ marginTop: 'var(--bk-spacing-2)' }}>
                                More content after centered divider.
                            </Paragraph>
                        </div>
                ...
                preview={
                    <div style={{ maxWidth: '700px' }}>
                        ...
                        <Paragraph style={{ marginBottom: 'var(--bk-spacing-4)' }}>
                            ...
                            understand all the features and capabilities of our platform.
                        </Paragraph>

                        <Divider label="Introduction" labelAlign="left" />

                        <Paragraph style={{ marginBottom: 'var(--bk-spacing-4)' }}>
                            Our platform provides a complete solution for building modern web
                            applications. It includes everything you need to get started quickly and
                            scale efficiently.
                        </Paragraph>
                        ...
                        <Paragraph style={{ marginBottom: 'var(--bk-spacing-4)' }}>
                            ...
                            Follow the installation guide and you'll be up and running in minutes.
                        </Paragraph>
                        ...
                        <Paragraph style={{ marginBottom: 'var(--bk-spacing-4)' }}>
                            ...
                            advanced analytics, seamless integrations, and enterprise-grade
                            security.
                        </Paragraph>
                        ...
                        <Paragraph>
                            Now that you understand the basics, explore our API reference and check
                            out the example projects to see the platform in action.
                        </Paragraph>
                    </div>
                }
                code={`<div>
