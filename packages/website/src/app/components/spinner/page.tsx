        ...
        <div style={{ minWidth: '400px' }}>
            <div style={{
                ...
                <div style={{
                    ...
                    border: 'var(--border-width-1) solid var(--vscode-panel-border)',
                    ...
                    {isLoading ? (
                        <div style={{ textAlign: 'center' }}>
                            <Spinner />
                            <p style={{ marginTop: 'var(--spacing-2)', fontSize: 'var(--font-size-sm)', color: 'var(--vscode-descriptionForeground)' }}>
                                Fetching data...
                            </p>
                        </div>
                    ) : data ? (
                        <p style={{ fontSize: 'var(--font-size-sm)', color: 'var(--vscode-foreground)' }}>
                            {data}
                        </p>
                    ) : (
                        <p style={{ fontSize: 'var(--font-size-sm)', color: 'var(--vscode-descriptionForeground)' }}>
...
function App() {
  return <Spinner />;
            ...
            <Showcase
                ...
                preview={
                    <div style={{ display: 'flex', gap: 'var(--spacing-8)', alignItems: 'center', flexWrap: 'wrap', justifyContent: 'center' }}>
                        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'var(--spacing-2)' }}>
                            <Spinner size="xs" />
                            <span style={{ fontSize: 'var(--font-size-xs)', color: 'var(--vscode-descriptionForeground)' }}>xs</span>
                        </div>
                        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'var(--spacing-2)' }}>
                            <Spinner size="sm" />
                            <span style={{ fontSize: 'var(--font-size-xs)', color: 'var(--vscode-descriptionForeground)' }}>sm</span>
                        </div>
                        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'var(--spacing-2)' }}>
                            <Spinner size="md" />
                            <span style={{ fontSize: 'var(--font-size-xs)', color: 'var(--vscode-descriptionForeground)' }}>md</span>
                        </div>
                        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'var(--spacing-2)' }}>
                            <Spinner size="lg" />
                            <span style={{ fontSize: 'var(--font-size-xs)', color: 'var(--vscode-descriptionForeground)' }}>lg</span>
                        </div>
                        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'var(--spacing-2)' }}>
                            <Spinner size="xl" />
                            <span style={{ fontSize: 'var(--font-size-xs)', color: 'var(--vscode-descriptionForeground)' }}>xl</span>
                        </div>
                    </div>
                }
                        ...
                        <div>
                            ...
                            <div style={{ display: 'flex', gap: 'var(--spacing-8)', alignItems: 'center', flexWrap: 'wrap' }}>
                                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'var(--spacing-2)' }}>
                                    ...
                                    <span style={{ fontSize: 'var(--font-size-xs)', color: 'var(--vscode-descriptionForeground)' }}>Primary</span>
                                </div>
                                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'var(--spacing-2)' }}>
                                    <Spinner color="var(--vscode-testing-iconPassed)" />
                                    <span style={{ fontSize: 'var(--font-size-xs)', color: 'var(--vscode-descriptionForeground)' }}>Success</span>
                                </div>
                                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'var(--spacing-2)' }}>
                                    <Spinner color="var(--vscode-editorWarning-foreground)" />
                                    <span style={{ fontSize: 'var(--font-size-xs)', color: 'var(--vscode-descriptionForeground)' }}>Warning</span>
                                </div>
                                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'var(--spacing-2)' }}>
                                    <Spinner color="var(--vscode-testing-iconFailed)" />
                                    <span style={{ fontSize: 'var(--font-size-xs)', color: 'var(--vscode-descriptionForeground)' }}>Danger</span>
                                </div>
                                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'var(--spacing-2)' }}>
                                    <Spinner color="var(--vscode-charts-purple)" />
                                    <span style={{ fontSize: 'var(--font-size-xs)', color: 'var(--vscode-descriptionForeground)' }}>Info</span>
                                </div>
                            </div>
                        </div>
                        <div>
                            ...
                            <div style={{ display: 'flex', gap: 'var(--spacing-8)', alignItems: 'center', flexWrap: 'wrap' }}>
                                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'var(--spacing-2)' }}>
                                    ...
                                    <span style={{ fontSize: 'var(--font-size-xs)', color: 'var(--vscode-descriptionForeground)' }}>#ff6600</span>
                                </div>
                                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'var(--spacing-2)' }}>
                                    <Spinner color="#9333ea" />
                                    <span style={{ fontSize: 'var(--font-size-xs)', color: 'var(--vscode-descriptionForeground)' }}>#9333ea</span>
                                </div>
                                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'var(--spacing-2)' }}>
                                    <Spinner color="#06b6d4" />
                                    <span style={{ fontSize: 'var(--font-size-xs)', color: 'var(--vscode-descriptionForeground)' }}>#06b6d4</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <Showcase
                ...
                preview={
                    ...
                    >
                        <div style={{ textAlign: 'center' }}>
                            <Spinner size="lg" />
                            <p style={{ marginTop: 'var(--spacing-3)', fontSize: 'var(--font-size-sm)', color: 'var(--vscode-descriptionForeground)' }}>
                                Loading content...
                            </p>
                        </div>
                    </div>
            ...
            <Showcase
                ...
                preview={
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-3)' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--spacing-2)', fontSize: 'var(--font-size-sm)', color: 'var(--vscode-foreground)' }}>
                ...
                code={`<div style={{ display: 'flex', alignItems: 'center', gap: 'var(--spacing-2)' }}>
  <span>Please wait while we fetch your data...</span>
  <Spinner size="xs" />
</div>
