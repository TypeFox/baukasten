...
import { Checkbox, Label } from 'baukasten-ui/core';
    ...
    return (
        ...
        >
            <Showcase
                ...
                code={`import { Checkbox, Label } from 'baukasten-ui/core';
                ...
                preview={
                    ...
                    >
                        <Label variant="checkbox" size="md">
                            <Checkbox />
                            <span>
                                This is a very long label that will wrap to multiple lines and
                                maintain proper alignment with the checkbox. The text wraps
                                naturally below the first line.
                            </span>
                        </Label>
                        <Label variant="checkbox" size="md">
                            <Checkbox variant="switch" />
                            <span>
                                ...
                                handled. Notice how the text wraps and stays aligned naturally.
                            </span>
                        </Label>
                    </div>
                }
