...
import { ProgressBar, Button, Heading, Paragraph } from 'baukasten-ui/core';
    ...
    return (
        ...
        >
            <Showcase
                ...
                code={`import { ProgressBar } from 'baukasten-ui/core';
...
<ProgressBar value={45} variant="warning" striped animated height="12px" />`}
            ...
            <Showcase
                ...
                code={`import { ProgressBar, Button } from 'baukasten-ui/core';
import { useState, useEffect } from 'react';
