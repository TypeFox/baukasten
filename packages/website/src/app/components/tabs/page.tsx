...
import { Tabs, TabList, Tab, TabPanels, TabPanel, Heading, Button, Input, FieldLabel, Checkbox, Label } from 'baukasten';
    ...
    return (
        ...
        >
            <Showcase
                ...
                code={`import { Tabs, TabList, Tab, TabPanels, TabPanel } from 'baukasten';
