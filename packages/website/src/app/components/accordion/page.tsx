...
import { Icon, Badge, Paragraph, Text, Code } from 'baukasten-ui/core';
    ...
    return (
        ...
        >
            <Showcase
                    ...
                    <div style={{ width: '100%', maxWidth: '500px' }}>
                        <Accordion>
                            <AccordionItem title="What is Baukasten?">
                                <Paragraph>
                                    Baukasten is a React component library for building VSCode
                                    webview UIs.
                                </Paragraph>
                            </AccordionItem>
                ...
                code={`import { Accordion, AccordionItem } from 'baukasten-ui/extra';
                    ...
                    <div style={{ width: '100%', maxWidth: '500px' }}>
                        <Accordion exclusive defaultOpen="performance">
                            ...
                            <AccordionItem id="theming" title="Theming">
                                <Paragraph>Automatic theme synchronization with VSCode.</Paragraph>
                            </AccordionItem>
                    ...
                    <div style={{ width: '100%', maxWidth: '500px' }}>
                        <Accordion>
                            <AccordionItem
                                ...
                                defaultOpen
                            >
                                <Paragraph>Configure general application settings.</Paragraph>
                            </AccordionItem>
                            <AccordionItem title="Notifications" icon={<Icon name="bell" />}>
                                <Paragraph>Manage notification preferences.</Paragraph>
                            </AccordionItem>
                            <AccordionItem title="Security" icon={<Icon name="shield" />}>
                                <Paragraph>Security and authentication settings.</Paragraph>
                            </AccordionItem>
                        </Accordion>
                    </div>
                }
                ...
                preview={
                    <div style={{ width: '100%', maxWidth: '600px' }}>
                        <Accordion>
                            ...
                            >
                                <Paragraph>Several critical bugs have been resolved.</Paragraph>
                            </AccordionItem>
                            <AccordionItem
                                title={
                                    <div
                            ...
                            >
                                <Paragraph>Try out experimental features in beta.</Paragraph>
                            </AccordionItem>
                        </Accordion>
                    </div>
                }
                    ...
                    <div style={{ width: '100%', maxWidth: '500px' }}>
                        <Accordion>
                            <AccordionItem title="Available Feature" defaultOpen>
                                <Paragraph>This feature is available and ready to use.</Paragraph>
                            </AccordionItem>
                            ...
                            <AccordionItem title="Beta Feature" icon={<Icon name="beaker" />}>
                                <Paragraph>This feature is in beta testing.</Paragraph>
                            </AccordionItem>
                            <AccordionItem
                            ...
                            >
                                <Paragraph>This feature will be removed soon.</Paragraph>
                            </AccordionItem>
                        </Accordion>
                    </div>
                }
                            ...
                            <AccordionItem title="Installation Guide" defaultOpen>
                                ...
                                >
                                    <li style={{ marginBottom: 'var(--bk-spacing-1)' }}>
                                        <Text>
                                            Install: <Code>npm install baukasten-ui</Code>
                                        </Text>
                                    </li>
                                    <li style={{ marginBottom: 'var(--bk-spacing-1)' }}>
                                    ...
                                    <li style={{ marginBottom: 'var(--bk-spacing-1)' }}>
                                        <Text>
                                            Add <Code>GlobalStyles</Code> to root
                                        </Text>
                                    </li>
                                </ol>
                            </AccordionItem>
