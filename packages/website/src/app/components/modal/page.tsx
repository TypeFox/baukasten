    ...
    return (
        ...
        >
            <Showcase
                ...
                code={`import { Modal, ModalHeader, ModalBody, ModalFooter, Button } from 'baukasten-ui/core';
import { useState } from 'react';
...
import { Modal, ModalHeader, ModalBody, ModalFooter, Button } from 'baukasten-ui/core';
        ...
        <ModalFooter>
          ...
          <Button variant="primary" onClick={handleDelete}>
            ...
            <Showcase
                ...
                preview={<FormExample />}
                code={`import { useState } from 'react';
import { Modal, ModalHeader, ModalBody, ModalFooter, Button, Input, FormGroup, FieldLabel, FormHelper } from 'baukasten-ui/core';
