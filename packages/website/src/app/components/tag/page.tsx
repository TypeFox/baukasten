            ...
            <Showcase
                ...
                preview={
                    ...
                    >
                        ...
                        >
                            <Tag variant="primary">
                                <Icon name="symbol-class" /> React
                            </Tag>
                            <Tag variant="info">
                                <Icon name="code" /> TypeScript
                            </Tag>
                            <Tag variant="success">
                                <Icon name="check" /> Approved
                            </Tag>
                            <Tag variant="warning">
                                <Icon name="warning" /> Draft
                            </Tag>
                            <Tag variant="error">
                                <Icon name="error" /> Deprecated
                            </Tag>
                        </div>
                        <div
                            style={{
            ...
            <Showcase
                ...
                preview={
                    ...
                    >
                        ...
                        >
                            <Tag variant="error">
                                <Icon name="flame" /> Critical
                            </Tag>
                            <Tag variant="warning">
                                <Icon name="arrow-up" /> High
                            </Tag>
                            <Tag variant="info">
                                <Icon name="dash" /> Medium
                            </Tag>
                            <Tag variant="secondary">
                                <Icon name="arrow-down" /> Low
                            </Tag>
                        </div>
                    </div>
                }
                ...
                preview={
                    ...
                    >
                        ...
                        <Tag variant="error" size="md">
                            <Icon name="bug" /> MD Error
                        </Tag>
                        <Tag variant="info" size="lg" outline>
                            <Icon name="info" /> LG Info
                        </Tag>
