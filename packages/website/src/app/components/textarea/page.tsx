...
const textAreaProps: PropDefinition[] = [
    ...
    },
    {
        ...
        type: 'string | boolean',
        description:
            'Error state or message. String displays error below, boolean only shows error border',
    },
    {
        name: 'fullWidth',
        type: 'boolean',
    ...
    },
    {
        ...
        default: '"vertical"',
        description:
            'Resize behavior for the textarea. Defaults to "none" when minRows/maxRows is set',
    },
    {
        name: 'rows',
        type: 'number',
        default: '4',
        description:
            'Number of visible text rows (static height, ignored when auto-grow is enabled)',
    },
    {
        name: 'minRows',
        type: 'number',
        description:
            'Minimum number of rows for auto-grow behavior. Setting this enables auto-grow',
    },
    {
        name: 'maxRows',
        type: 'number',
        description:
            'Maximum number of rows for auto-grow behavior. Setting this enables auto-grow',
    },
    {
        name: 'placeholder',
        type: 'string',
    ...
    return (
        ...
        >
            <Showcase
                ...
                preview={<TextArea placeholder="Enter your message here..." />}
                ...
                preview={
                    ...
                    >
                        ...
                        <div>
                            ...
                            <TextArea
                                resize="both"
                                placeholder="Drag corner to resize in any direction"
                                rows={3}
                            />
                        </div>
                    </div>
                ...
                preview={
                    ...
                    >
                        ...
                        <div>
                            ...
                            <TextArea maxRows={5} placeholder="Only maxRows set" fullWidth />
                        </div>
                    </div>
                }
...
<div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
  ...
  <TextArea placeholder="Notes (optional)" fullWidth rows={4} />
            ...
            >
                ...
                >
                    <li style={{ marginBottom: 'var(--bk-spacing-2)' }}>
                        <strong>String error:</strong> Displays the error message below the textarea
                        and shows error border styling
                    </li>
                    <li style={{ marginBottom: 'var(--bk-spacing-2)' }}>
                        <strong>Boolean error:</strong> Only shows error border styling, no message
                        displayed
                    </li>
                    <li>
                        <strong>With FormHelper:</strong> Use boolean error for border, then add
                        FormHelper component for more control over error display
                    </li>
                </ul>
            </div>
            ...
            >
                ...
                >
                    <li style={{ marginBottom: 'var(--bk-spacing-2)' }}>
                        Uses native <code>&lt;textarea&gt;</code> element for full browser support
                        and accessibility
                    </li>
                    <li style={{ marginBottom: 'var(--bk-spacing-2)' }}>
                        Supports all standard textarea attributes: <code>name</code>,{' '}
                        <code>id</code>, <code>value</code>, <code>onChange</code>, etc.
                    </li>
                    <li style={{ marginBottom: 'var(--bk-spacing-2)' }}>
                        Error messages are automatically associated with the textarea for screen
                        readers
                    </li>
                    <li>
                        Use with <code>FieldLabel</code> and <code>htmlFor</code> attribute to
                        connect labels to textareas
                    </li>
                </ul>
            </div>
            ...
            >
                ...
                >
                    <li style={{ marginBottom: 'var(--bk-spacing-2)' }}>
                        <strong>Row count:</strong> Use 2-3 rows for short inputs, 4-6 for medium
                        content, 8+ for long form content
                    </li>
                    <li style={{ marginBottom: 'var(--bk-spacing-2)' }}>
                        <strong>Auto-grow:</strong> Use <code>minRows</code> and{' '}
                        <code>maxRows</code> for chat inputs, comments, or any variable-length
                        content. Great for improving UX by adapting to content
                    </li>
                    <li style={{ marginBottom: 'var(--bk-spacing-2)' }}>
                        <strong>Resize:</strong> Use <code>resize="vertical"</code> (default) for
                        most cases. Use <code>resize="none"</code> for fixed-height fields like
                        titles. Auto-grow textareas default to <code>resize="none"</code>
                    </li>
                    <li style={{ marginBottom: 'var(--bk-spacing-2)' }}>
                        <strong>Full width:</strong> Always use <code>fullWidth</code> in form
                        layouts for consistent sizing
                    </li>
                    <li style={{ marginBottom: 'var(--bk-spacing-2)' }}>
                        <strong>Placeholder:</strong> Use clear, concise placeholder text that
                        describes the expected input
                    </li>
                    <li style={{ marginBottom: 'var(--bk-spacing-2)' }}>
                        <strong>Labels:</strong> Always pair with <code>FieldLabel</code> or use{' '}
                        <code>aria-label</code> for accessibility
                    </li>
                    <li>
                        <strong>Error messages:</strong> Provide specific, actionable error messages
                        that help users fix validation issues
                    </li>
                </ul>
            </div>
        </PageLayout>
