...
import { Label, Input, Select, TextArea, Checkbox, Icon, Badge, Button } from 'baukasten-ui/core';
...
const labelProps: PropDefinition[] = [
    ...
    },
    {
        ...
        default: '"md"',
        description:
            'Size to match the form element inside. Should match child component size for proper alignment',
    },
    {
        name: 'fullWidth',
        type: 'boolean',
    ...
    },
    {
        ...
        description:
            'Content of the label - can include inputs, selects, textareas, checkboxes, and label spans',
    },
];
    ...
    return (
        ...
        >
            <Showcase
                ...
                code={`import { Label, Input } from 'baukasten-ui/core';
                ...
                preview={
                    ...
                    >
                        ...
                        <Label variant="textarea" fullWidth>
                            <span className="label">
                                Bio
                                <Badge variant="warning" size="xs" style={{ marginLeft: 'auto' }}>
                                    Max 500 chars
                                </Badge>
                            </span>
                    ...
                    >
                        <Label variant="checkbox" size="md">
                            ...
                            <span>
                                ...
                                data processing agreement. I understand that my data will be
                        ...
                        <Label variant="checkbox" size="md">
                            ...
                            <span>
                                I consent to receive marketing communications including newsletters,
                                product updates, and special offers. I can unsubscribe at any time.
                            </span>
                        </Label>
                    </div>
                }
