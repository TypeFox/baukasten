...
import { Icon, Button } from 'baukasten-ui/core';
...
const iconProps: PropDefinition[] = [
    {
        ...
        required: true,
        description:
            'The codicon name (without the "codicon-" prefix). See https://microsoft.github.io/vscode-codicons for all available icons.',
    },
    {
        name: 'size',
    ...
    },
    {
        ...
        type: 'string',
        description:
            'Optional color override (CSS color value). When not provided, icons inherit color from their parent component.',
    },
    {
        name: 'spin',
        type: 'boolean',
