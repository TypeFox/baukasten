    ...
    return (
        ...
        >
            <Alert variant="info" style={{ marginBottom: 'var(--bk-spacing-8)' }}>
                Baukasten is built with VSCode's theming system in mind, making it automatically
                compatible with all VSCode and Theia color themes.
            </Alert>
            ...
            <section style={{ marginBottom: 'var(--bk-spacing-12)' }}>
                ...
                >
                    Baukasten uses CSS variables (custom properties) for theming. Simply import the
                    appropriate platform CSS file for your environment, and optionally override any
                    variables to customize the appearance.
                </p>
            </section>
            ...
            <section style={{ marginBottom: 'var(--bk-spacing-12)' }}>
                ...
                >
                    Baukasten provides three platform-specific CSS files. Import the one that
                ...
                >
                    ...
                    >
                        ...
                        >
                            <Badge variant="info" style={{ marginRight: 'var(--bk-spacing-2)' }}>
                                VS Code
                            </Badge>
                        ...
                        >
                            Uses <Code>--vscode-*</Code> CSS variables. Components automatically
                            adapt to the user's VS Code theme.
                        </p>
                        <CodeBlock
                            language="tsx"
...
import 'baukasten-ui/dist/baukasten-vscode.css';`}
                    ...
                    >
                        ...
                        >
                            <Badge variant="warning" style={{ marginRight: 'var(--bk-spacing-2)' }}>
                                Theia
                            </Badge>
                            baukasten-theia.css
                        </h3>
                        ...
                        >
                            Uses <Code>--theia-*</Code> CSS variables. Components automatically
                            adapt to the Eclipse Theia theme.
                        </p>
                        <CodeBlock
                            language="tsx"
                            code={`import 'baukasten-ui/dist/baukasten-base.css';
import 'baukasten-ui/dist/baukasten-theia.css';`}
                    ...
                    >
                        ...
                        >
                            <Badge variant="default" style={{ marginRight: 'var(--bk-spacing-2)' }}>
                                Web
                            </Badge>
                            baukasten-web.css
                        </h3>
                        ...
                        >
                            Uses default fallback values for standalone web applications. This is
                            the file you'll want to customize.
                        </p>
                        <CodeBlock
                            language="tsx"
                            code={`import 'baukasten-ui/dist/baukasten-base.css';
import 'baukasten-ui/dist/baukasten-web.css';`}
            ...
            <section style={{ marginBottom: 'var(--bk-spacing-12)' }}>
                ...
                >
                    After importing the platform CSS file, simply override the CSS variables you
                    want to customize. You can do this in your own CSS file or in a{' '}
                    <Code>&lt;style&gt;</Code> tag:
                </p>
                <CodeBlock
                    language="css"
...
import './your-custom-theme.css';`}
            ...
            <section style={{ marginBottom: 'var(--bk-spacing-12)' }}>
                ...
                >
                    For dynamic theme switching (e.g., light/dark mode toggle), you can update CSS
                    variables at runtime using JavaScript:
                </p>
                <CodeBlock
                    language="tsx"
...
applyTheme(lightTheme); // Switch to light theme`}
            ...
            <section style={{ marginBottom: 'var(--bk-spacing-12)' }}>
                ...
                >
                    For convenience, the <Code>baukasten-ui-web-wrapper</Code> package provides
...
applyTheme(darkModern);`}
            ...
            <section style={{ marginBottom: 'var(--bk-spacing-12)' }}>
                ...
                >
                    ...
                    >
                        ...
                        <span style={{ color: 'var(--bk-color-text-secondary)' }}>
                            Primary brand color
                        </span>
                ...
                >
                    ...
                    >
                        ...
                        <span style={{ color: 'var(--bk-color-text-secondary)' }}>
                            Secondary background (e.g., sidebars)
                        </span>
                        <Code>--bk-color-background-elevated</Code>
                        <span style={{ color: 'var(--bk-color-text-secondary)' }}>
                            Elevated surfaces (e.g., modals)
                        </span>
            ...
            <section style={{ marginBottom: 'var(--bk-spacing-12)' }}>
                ...
                >
                    For component-specific customization, you can use inline styles with CSS
                    variables:
                </p>
                <CodeBlock
                    language="tsx"
                ...
                >
                    ...
                    >
                        ...
                        <div>
                            ...
                            >
                                Use <Code>baukasten-vscode.css</Code> for VS Code,{' '}
                                <Code>baukasten-theia.css</Code> for Theia, or{' '}
                                <Code>baukasten-web.css</Code> for standalone web apps
                            </p>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <div>
                            ...
                            >
                                Override <Code>--bk-color-*</Code> tokens (e.g.,{' '}
                                <Code>--bk-color-primary</Code>) instead of <Code>--vscode-*</Code>{' '}
                                or <Code>--theia-*</Code> variables
                            </p>
                        </div>
                    </div>
