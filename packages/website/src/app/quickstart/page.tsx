...
import { Heading, Alert, Icon, Button } from 'baukasten-ui/core';
...
export default function QuickStartPage() {
    return (
        ...
        >
            ...
            >
                This guide will get you started quickly. For more detailed setup instructions and
                configuration options, check out the{' '}
                <Link
                    href="/installation"
                    style={{
            ...
            <Section>
                ...
                <Paragraph>Install the package using npm, yarn, or pnpm:</Paragraph>
            ...
            <Section>
                ...
                <Paragraph>
                    The setup depends on whether you're building a VSCode extension or a web
                    application.
                </Paragraph>
                ...
                <div style={{ marginBottom: 'var(--bk-spacing-8)' }}>
                    ...
                    <Paragraph>
                        For VSCode extensions, the components automatically use VSCode's native
                        theme variables. Just add GlobalStyles and start using components:
                    </Paragraph>
                    <CodeBlock
...
export default App;`}
                ...
                <div>
                    ...
                    <Paragraph>
                        For web apps, you'll need the theme wrapper to simulate VSCode's theme
                        system:
                    </Paragraph>
...
export default App;`}
                    ...
                    >
                        ...
                        >
                            ...
                            <div>
                                ...
                                <Paragraph>
                                    All components automatically adapt to VSCode's theme. Whether
                                    your users prefer Dark+, Light+, or any custom theme, your UI
                        ...
                        >
                            ...
                            <div>
                                ...
                                <Paragraph>
                                    ...
                                    for consistent styling. Check out the{' '}
                                    <Link
                        ...
                        >
                            ...
                            <div>
                                ...
                                <Paragraph>
                                    ...
                                    . The bundler will automatically exclude unused components,
                    ...
                    >
                        ...
                        >
                            ...
                            <div>
                                ...
                                <Paragraph>
                                    Every component is fully typed with comprehensive TypeScript
                                    definitions. Get IntelliSense, autocomplete, and type checking
                                    out of the box.
                                </Paragraph>
                            </div>
                        </div>
            ...
            <Section>
                ...
                <Paragraph>
                    Now that you have Baukasten installed, explore the component library to see
                    what's available:
                </Paragraph>
                ...
                >
                    <Link href="/components/button" style={{ textDecoration: 'none' }}>
                        ...
                        >
                            ...
                            <Paragraph>
                                Browse 30+ production-ready components with live examples and props
                                documentation.
                            </Paragraph>
                        </div>
                    </Link>
                    ...
                    <Link href="/foundations/colors" style={{ textDecoration: 'none' }}>
                        ...
                        >
                            ...
                            <Paragraph>
                                Learn about colors, typography, spacing, and effects in the design
                                system.
                            </Paragraph>
                        </div>
                    </Link>
            ...
            <Alert variant="success" icon={<Icon name="check" />} title="You're All Set!">
                <div>
                    <p style={{ margin: '0 0 var(--bk-spacing-3) 0' }}>
                        You now have everything you need to start building with Baukasten. Here are
                        some tips to get the most out of the library:
                    </p>
                    <ul style={{ margin: '0', paddingLeft: 'var(--bk-spacing-5)' }}>
                        <li style={{ marginBottom: 'var(--bk-spacing-2)' }}>
                            Use the component docs to explore all available props and variants
                        </li>
                        <li style={{ marginBottom: 'var(--bk-spacing-2)' }}>
                            Leverage design tokens (CSS variables) for consistent custom styling
                        </li>
                        <li style={{ marginBottom: 'var(--bk-spacing-2)' }}>
                            Check out the Storybook for interactive component examples
                        </li>
