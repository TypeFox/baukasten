...
export default function InstallationPage() {
    return (
        <PageLayout title="Installation" description="Get started with Baukasten in your project.">
            <Section>
            ...
            <Section>
                ...
                <Paragraph>Install Baukasten and its peer dependencies using npm:</Paragraph>
            ...
            <Section>
                ...
                <Paragraph>
                    Baukasten provides pre-built CSS files for different platforms. Import the
                    appropriate CSS files based on your target environment:
                </Paragraph>
                ...
                >
                    ...
                    >
                        ...
                        <tbody>
                            <tr style={{ borderBottom: '1px solid var(--bk-color-border)' }}>
                                <td style={{ padding: 'var(--bk-spacing-2) var(--bk-spacing-4)' }}>
                                    <Code>baukasten-base.css</Code>
                                </td>
                                <td
                                    style={{
                                        padding: 'var(--bk-spacing-2) var(--bk-spacing-4)',
                                ...
                                >
                                    Component styles (vanilla-extract)
                                </td>
                                <td
                                    style={{
                                        padding: 'var(--bk-spacing-2) var(--bk-spacing-4)',
                            ...
                            <tr style={{ borderBottom: '1px solid var(--bk-color-border)' }}>
                                <td style={{ padding: 'var(--bk-spacing-2) var(--bk-spacing-4)' }}>
                                    <Code>baukasten-vscode.css</Code>
                                </td>
                                <td
                                    style={{
                                        padding: 'var(--bk-spacing-2) var(--bk-spacing-4)',
                                ...
                                >
                                    Uses <Code>--vscode-*</Code> CSS variables
                                </td>
                                <td
                                    style={{
                                        padding: 'var(--bk-spacing-2) var(--bk-spacing-4)',
                            ...
                            <tr style={{ borderBottom: '1px solid var(--bk-color-border)' }}>
                                ...
                                >
                                    Uses <Code>--theia-*</Code> CSS variables
                                </td>
                                <td
                                    style={{
                                        padding: 'var(--bk-spacing-2) var(--bk-spacing-4)',
                                ...
                                >
                                    Eclipse Theia applications
                                </td>
                            </tr>
                            <tr>
                                <td style={{ padding: 'var(--bk-spacing-2) var(--bk-spacing-4)' }}>
                                    <Code>baukasten-web.css</Code>
                                </td>
                                <td
                                    style={{
                                        padding: 'var(--bk-spacing-2) var(--bk-spacing-4)',
            ...
            <Section>
                ...
                <Paragraph>
                    For VSCode webview extensions, import the base styles and the VSCode-specific
                    CSS file:
                </Paragraph>
                <CodeBlock
  ...
  return (
    <div>
      <Button>Hello VSCode</Button>
                ...
                />
                <Paragraph>
                    The components will automatically use VSCode's native theme variables, adapting
    ...
    <div>
      <Button>Hello Theia</Button>
            ...
            <Section>
                ...
                <Paragraph>
                    For standalone web applications, use the web CSS file which includes sensible
                    default values:
                </Paragraph>
                <CodeBlock
                    code={`// Import the required CSS files
  ...
  return (
    <div>
      <Button>Hello Web</Button>
                ...
                />
                <Paragraph>
                    You can customize the theme by overriding the CSS variables. See the{' '}
                    <a href="/guides/theming" style={{ color: 'var(--bk-color-link)' }}>
                        Theming Guide
                    </a>{' '}
                    for details.
                </Paragraph>
            ...
            <Section>
                ...
                <Paragraph>
                    For advanced theme management with pre-built theme presets and theme switching,
                    you can optionally use the web wrapper package:
                </Paragraph>
                <CodeBlock code="npm install baukasten-ui-web-wrapper" language="bash" />
                <Paragraph>
                    This package provides VSCode-compatible themes that can be dynamically switched
                    at runtime.
                </Paragraph>
                <CodeBlock
    ...
    <VSCodeThemeWrapper>
      <Button>Hello Web</Button>
            ...
            <Section>
                ...
                <Paragraph>
                    For Next.js applications, you may need to configure package transpilation in
                    next.config.js. This tells Next.js to compile the packages through its build
                    pipeline, which is needed because baukasten-ui is distributed as ESM and uses
...
module.exports = nextConfig`}
                    language="javascript"
                />
                <Paragraph>Then import the CSS files in your root layout:</Paragraph>
                <CodeBlock
                    code={`// app/layout.tsx
import 'baukasten-ui/dist/baukasten-base.css';
import 'baukasten-ui/dist/baukasten-web.css';
      ...
      <body>
        {children}
            ...
            <Section>
                ...
                <Paragraph>Import individual components as needed:</Paragraph>
                <CodeBlock
    ...
    <div>
      ...
      <Badge>New</Badge>
            ...
            <Section>
                ...
                <Paragraph>You can access the design token system for custom styling:</Paragraph>
                <CodeBlock
    ...
    Content
            ...
            <Section>
                ...
                <Alert variant="warning" style={{ marginBottom: 'var(--bk-spacing-4)' }}>
                    The GlobalStyles component is deprecated. Please use the CSS file imports shown
                    above instead.
                </Alert>
                <Paragraph>
                    For legacy applications, you can still use the GlobalStyles component, but this
                    approach is deprecated and will be removed in a future version:
                </Paragraph>
                <CodeBlock
    ...
    <>
      ...
      <Button>Hello</Button>
            ...
            <Section>
                ...
                <Paragraph>
                    Now that you have Baukasten installed, explore the component documentation to
                    see what's available and how to use each component. Check out the{' '}
                    <a href="/guides/theming" style={{ color: 'var(--bk-color-link)' }}>
                        Theming Guide
                    </a>{' '}
