...
const interactiveColors: ColorToken[] = [
    ...
    { name: 'Selected', variable: '--bk-color-selected', description: 'Selected item background' },
    {
        ...
        variable: '--bk-color-selected-foreground',
    ...
    return (
        ...
        >
            <section style={{ marginBottom: 'var(--bk-padding-2xl)' }}>
                ...
                >
                    All color tokens use CSS variables and automatically map to VSCode theme
                    variables. They can be easily customized for web applications or other
                    platforms.
                </p>
                <CodeBlock
                    language="tsx"
