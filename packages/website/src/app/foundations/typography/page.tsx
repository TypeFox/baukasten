...
const fontSizes: TypeToken[] = [
    {
        name: 'Extra Small',
        variable: '--bk-font-size-xs',
        value: '11px',
        description: 'Labels, captions',
    },
    {
        name: 'Small',
        variable: '--bk-font-size-sm',
        value: '12px',
        description: 'Helper text, small UI',
    },
    { name: 'Medium', variable: '--bk-font-size-md', value: '13px', description: 'Secondary text' },
    {
        name: 'Base',
        variable: '--bk-font-size-base',
        value: '14px',
    ...
    {
        name: '3X Large',
        variable: '--bk-font-size-3xl',
        value: '24px',
        description: 'Large headings',
    },
    {
        name: '4X Large',
        variable: '--bk-font-size-4xl',
        value: '30px',
        description: 'Display headings',
    },
    {
        name: '5X Large',
        variable: '--bk-font-size-5xl',
        value: '36px',
...
const lineHeights: TypeToken[] = [
    {
        name: 'Hero',
        variable: '--bk-line-height-hero',
        value: '1.1',
        description: 'Extra tight for large text',
    },
    {
        name: 'Tight',
        variable: '--bk-line-height-tight',
        value: '1.25',
        description: 'Compact spacing',
    },
    {
        name: 'Normal',
        variable: '--bk-line-height-normal',
        value: '1.5',
        description: 'Standard readability',
    },
    {
        name: 'Relaxed',
        variable: '--bk-line-height-relaxed',
        value: '1.75',
        description: 'Comfortable reading',
    },
    {
        name: 'Loose',
        variable: '--bk-line-height-loose',
        value: '2',
...
const letterSpacings: TypeToken[] = [
    {
        name: 'Hero',
        variable: '--bk-letter-spacing-hero',
        value: '-0.04em',
        description: 'Extra tight for large text',
    },
    {
        name: 'Tight',
        variable: '--bk-letter-spacing-tight',
        value: '-0.025em',
        description: 'Slight tightening',
    },
    {
        name: 'Normal',
        variable: '--bk-letter-spacing-normal',
        value: '0',
        description: 'Default spacing',
    },
    {
        name: 'Wide',
        variable: '--bk-letter-spacing-wide',
        value: '0.025em',
        description: 'Slight expansion',
    },
    {
        name: 'Wider',
        variable: '--bk-letter-spacing-wider',
        value: '0.05em',
        description: 'Expanded spacing',
    },
];
    ...
    return (
        ...
        >
            <section style={{ marginBottom: 'var(--bk-padding-2xl)' }}>
                ...
                >
                    Typography tokens provide consistent text styling across the design system. All
                    values are defined as CSS variables and can be customized.
                </p>
                <CodeBlock
                    language="tsx"
