...
const borderRadii: EffectToken[] = [
    ...
    {
        name: 'Extra Large',
        variable: '--bk-radius-xl',
        value: '8px',
        description: 'Heavy rounding',
    },
    {
        name: '2X Large',
        variable: '--bk-radius-2xl',
        value: '12px',
        description: 'Maximum rounding',
    },
    {
        name: '3X Large',
        variable: '--bk-radius-3xl',
        value: '16px',
        description: 'Very heavy rounding',
    },
    {
        name: 'Full',
        variable: '--bk-radius-full',
        value: '9999px',
        description: 'Circular/pill shape',
    },
];
...
const transitions: EffectToken[] = [
    {
        name: 'Fast',
        variable: '--bk-transition-fast',
        value: '100ms',
        description: 'Quick animations',
    },
    {
        name: 'Base',
        variable: '--bk-transition-base',
        value: '150ms',
        description: 'Standard animations',
    },
    {
        name: 'Slow',
        variable: '--bk-transition-slow',
        value: '300ms',
...
const transitionProperties: EffectToken[] = [
    {
        name: 'Colors',
        variable: '--bk-transition-colors',
        description: 'Color, background, and border transitions',
    },
    { name: 'All', variable: '--bk-transition-all', description: 'All properties transition' },
    {
        name: 'Transform',
        variable: '--bk-transition-transform',
        description: 'Transform property transitions',
    },
...
const opacityLevels: EffectToken[] = [
    {
        name: 'Disabled',
        variable: '--bk-opacity-disabled',
        value: '0.4',
        description: 'Disabled state opacity',
    },
    {
        name: 'Muted',
        variable: '--bk-opacity-muted',
        value: '0.6',
        description: 'Muted content opacity',
    },
    {
        name: 'Hover',
        variable: '--bk-opacity-hover',
        value: '0.8',
...
const zIndexLevels: EffectToken[] = [
    ...
    {
        name: 'Dropdown',
        variable: '--bk-z-index-dropdown',
        value: '1000',
        description: 'Dropdown menus',
    },
    {
        name: 'Sticky',
        variable: '--bk-z-index-sticky',
        value: '1020',
    ...
    {
        name: 'Modal Backdrop',
        variable: '--bk-z-index-modal-backdrop',
        value: '1040',
    ...
    {
        name: 'Context Menu',
        variable: '--bk-z-index-context-menu',
        value: '1065',
    ...
    {
        name: 'Notification',
        variable: '--bk-z-index-notification',
        value: '1080',
    ...
    return (
        ...
        >
            <section style={{ marginBottom: 'var(--bk-padding-2xl)' }}>
                ...
                >
                    Effects tokens provide consistent visual styling for shadows, borders,
                    animations, and layering. Use these to create depth, smooth transitions, and
    ...
    <div style={{
      ...
      {children}
            ...
            <section style={{ marginBottom: 'var(--bk-padding-2xl)' }}>
                ...
                >
                    Semantic opacity values for disabled, muted, and hover states. Full scale from
                    0-100 also available.
                </p>
                <div
                    style={{
                        display: 'grid',
                ...
                >
                    ...
                    >
                        Full opacity scale also available: <Code>--bk-opacity-0</Code> through{' '}
                        <Code>--bk-opacity-100</Code> (0 to 1 in increments of 0.1)
                    </p>
                </div>
            </section>
