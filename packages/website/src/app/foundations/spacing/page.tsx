    ...
    return (
        ...
        >
            <section style={{ marginBottom: 'var(--bk-padding-2xl)' }}>
                ...
                >
                    The spacing system uses a 4px base unit to create a consistent rhythm throughout
                    the UI. All spacing values are multiples or divisions of this base unit.
                </p>
                <CodeBlock
                    language="tsx"
    ...
    <div style={{
      ...
      {children}
            ...
            <section style={{ marginBottom: 'var(--bk-padding-2xl)' }}>
                ...
                >
                    The fundamental spacing scale from 0px to 96px. Use these for margin, padding,
            ...
            <section style={{ marginBottom: 'var(--bk-padding-2xl)' }}>
                ...
                >
                    Semantic padding values for components. Includes vertical and horizontal
                    spacing.
                </p>
                <div
                    style={{
